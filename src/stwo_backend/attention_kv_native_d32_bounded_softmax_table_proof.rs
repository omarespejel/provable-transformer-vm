...
pub const ZKAI_ATTENTION_KV_NATIVE_D32_BOUNDED_SOFTMAX_TABLE_INPUT_SCHEMA: &str =
    "zkai-attention-kv-stwo-native-d32-bounded-softmax-table-air-proof-input-v1";
pub const ZKAI_ATTENTION_KV_NATIVE_D32_BOUNDED_SOFTMAX_TABLE_INPUT_DECISION: &str =
    "GO_INPUT_FOR_STWO_NATIVE_ATTENTION_KV_D32_BOUNDED_SOFTMAX_TABLE_AIR_PROOF";
pub const ZKAI_ATTENTION_KV_NATIVE_D32_BOUNDED_SOFTMAX_TABLE_PROOF_VERSION: &str =
    "stwo-attention-kv-d32-causal-mask-bounded-softmax-table-air-proof-v1";
pub const ZKAI_ATTENTION_KV_NATIVE_D32_BOUNDED_SOFTMAX_TABLE_STATEMENT_VERSION: &str =
    "zkai-attention-kv-stwo-native-d32-bounded-softmax-table-statement-v1";
pub const ZKAI_ATTENTION_KV_NATIVE_D32_BOUNDED_SOFTMAX_TABLE_SEMANTIC_SCOPE: &str =
    "d32_bounded_table_softmax_approx_attention_kv_causal_mask_rows_bound_to_statement_receipt";
pub const ZKAI_ATTENTION_KV_NATIVE_D32_BOUNDED_SOFTMAX_TABLE_DECISION: &str =
    "GO_STWO_NATIVE_ATTENTION_KV_BOUNDED_SOFTMAX_TABLE_AIR_PROOF";
pub const ZKAI_ATTENTION_KV_NATIVE_D32_BOUNDED_SOFTMAX_TABLE_TARGET_ID: &str =
    "attention-kv-d32-causal-mask-bounded-softmax-table-v1";
pub const ZKAI_ATTENTION_KV_NATIVE_D32_BOUNDED_SOFTMAX_TABLE_REQUIRED_BACKEND_VERSION: &str =
    "stwo-attention-kv-d32-causal-mask-bounded-softmax-table-v1";
pub const ZKAI_ATTENTION_KV_NATIVE_D32_BOUNDED_SOFTMAX_TABLE_VERIFIER_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d32-bounded-softmax-table:v1";
...
pub const ZKAI_ATTENTION_KV_NATIVE_D32_BOUNDED_SOFTMAX_TABLE_MAX_INPUT_JSON_BYTES: usize =
    1_048_576;
pub const ZKAI_ATTENTION_KV_NATIVE_D32_BOUNDED_SOFTMAX_TABLE_MAX_ENVELOPE_JSON_BYTES: usize =
    2_097_152;
...
pub const ZKAI_ATTENTION_KV_NATIVE_D32_BOUNDED_SOFTMAX_TABLE_MAX_PROOF_BYTES: usize = 131_072;

const ROW_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d32-bounded-softmax-table-score-rows:v1";
const INITIAL_KV_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d32-bounded-softmax-table-initial-kv:v1";
const INPUT_STEPS_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d32-bounded-softmax-table-input-steps:v1";
const FINAL_KV_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d32-bounded-softmax-table-final-kv:v1";
const OUTPUTS_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d32-bounded-softmax-table-outputs:v1";
const PUBLIC_INSTANCE_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d32-bounded-softmax-table-public-instance:v1";
const PROOF_NATIVE_PARAMETER_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d32-bounded-softmax-table-proof-parameters:v1";
const WEIGHT_TABLE_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d32-bounded-softmax-table-weight-table:v1";
...
const NEXT_BACKEND_STEP: &str = "fuse this d32 bounded Softmax-table source with AIR-private LogUp table membership, then compare against a matched d32 source-plus-sidecar route";

const EXPECTED_VALIDATION_COMMANDS: &[&str] = &[
    "python3 scripts/zkai_attention_kv_stwo_native_d32_bounded_softmax_table_proof_input.py --write-json docs/engineering/evidence/zkai-attention-kv-stwo-native-d32-bounded-softmax-table-proof-2026-05.json --write-tsv docs/engineering/evidence/zkai-attention-kv-stwo-native-d32-bounded-softmax-table-proof-2026-05.tsv",
    "python3 -m unittest scripts.tests.test_zkai_attention_kv_stwo_native_d32_bounded_softmax_table_proof_input",
    "cargo +nightly-2025-07-14 test attention_kv_native_d32_bounded_softmax_table_proof --lib --features stwo-backend",
    "cargo +nightly-2025-07-14 run --features stwo-backend --bin zkai_attention_kv_native_d32_bounded_softmax_table_proof -- prove docs/engineering/evidence/zkai-attention-kv-stwo-native-d32-bounded-softmax-table-proof-2026-05.json docs/engineering/evidence/zkai-attention-kv-stwo-native-d32-bounded-softmax-table-proof-2026-05.envelope.json",
    "cargo +nightly-2025-07-14 run --features stwo-backend --bin zkai_attention_kv_native_d32_bounded_softmax_table_proof -- verify docs/engineering/evidence/zkai-attention-kv-stwo-native-d32-bounded-softmax-table-proof-2026-05.envelope.json",
    "python3 scripts/zkai_attention_kv_d32_bounded_softmax_table_native_gate.py --write-json docs/engineering/evidence/zkai-attention-kv-stwo-native-d32-bounded-softmax-table-gate-2026-05.json --write-tsv docs/engineering/evidence/zkai-attention-kv-stwo-native-d32-bounded-softmax-table-gate-2026-05.tsv",
    "python3 -m unittest scripts.tests.test_zkai_attention_kv_d32_bounded_softmax_table_native_gate",
    "just lib",
    "just gate-fast",
    "just gate",
];
...
#[derive(Debug, Clone)]
struct AttentionKvNativeD32BoundedSoftmaxTableEval;

impl FrameworkEval for AttentionKvNativeD32BoundedSoftmaxTableEval {
...
pub struct AttentionKvD32BoundedSoftmaxTableEntry {
    pub position: usize,
    pub key: Vec<i64>,
    pub value: Vec<i64>,
}
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct AttentionKvD32BoundedSoftmaxTableInputStep {
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct AttentionKvD32BoundedSoftmaxTableWeightEntry {
    pub gap: usize,
    pub weight: i64,
}
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct AttentionKvD32BoundedSoftmaxTableScoreRow {
    pub row_index: usize,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct ZkAiAttentionKvNativeD32BoundedSoftmaxTableProofInput {
    pub schema: String,
    pub decision: String,
    pub issue: usize,
    ...
    pub weight_table: Vec<AttentionKvD32BoundedSoftmaxTableWeightEntry>,
    ...
    pub initial_kv_cache: Vec<AttentionKvD32BoundedSoftmaxTableEntry>,
    pub input_steps: Vec<AttentionKvD32BoundedSoftmaxTableInputStep>,
    pub final_kv_cache: Vec<AttentionKvD32BoundedSoftmaxTableEntry>,
    pub attention_outputs: Vec<Vec<i64>>,
    pub score_rows: Vec<AttentionKvD32BoundedSoftmaxTableScoreRow>,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct ZkAiAttentionKvNativeD32BoundedSoftmaxTableEnvelope {
    pub proof_backend: StarkProofBackend,
    pub proof_backend_version: String,
    pub statement_version: String,
    pub semantic_scope: String,
    pub decision: String,
    pub input: ZkAiAttentionKvNativeD32BoundedSoftmaxTableProofInput,
    pub proof: Vec<u8>,
}

#[derive(Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
struct AttentionKvNativeD32BoundedSoftmaxTableProofPayload {
    stark_proof: StarkProof<Blake2sM31MerkleHasher>,
}

pub fn zkai_attention_kv_native_d32_bounded_softmax_table_input_from_json_str(
    raw_json: &str,
) -> Result<ZkAiAttentionKvNativeD32BoundedSoftmaxTableProofInput> {
    if raw_json.len() > ZKAI_ATTENTION_KV_NATIVE_D32_BOUNDED_SOFTMAX_TABLE_MAX_INPUT_JSON_BYTES {
    ...
    let input: ZkAiAttentionKvNativeD32BoundedSoftmaxTableProofInput =
...
pub fn prove_zkai_attention_kv_native_d32_bounded_softmax_table_envelope(
    input: &ZkAiAttentionKvNativeD32BoundedSoftmaxTableProofInput,
) -> Result<ZkAiAttentionKvNativeD32BoundedSoftmaxTableEnvelope> {
    validate_input(input)?;
    Ok(ZkAiAttentionKvNativeD32BoundedSoftmaxTableEnvelope {
        proof_backend: StarkProofBackend::Stwo,
        proof_backend_version:
            ZKAI_ATTENTION_KV_NATIVE_D32_BOUNDED_SOFTMAX_TABLE_REQUIRED_BACKEND_VERSION.to_string(),
        statement_version: ZKAI_ATTENTION_KV_NATIVE_D32_BOUNDED_SOFTMAX_TABLE_STATEMENT_VERSION
            .to_string(),
        semantic_scope: ZKAI_ATTENTION_KV_NATIVE_D32_BOUNDED_SOFTMAX_TABLE_SEMANTIC_SCOPE
            .to_string(),
        decision: ZKAI_ATTENTION_KV_NATIVE_D32_BOUNDED_SOFTMAX_TABLE_DECISION.to_string(),
        input: input.clone(),
        proof: prove_rows(input)?,
    })
}

pub fn zkai_attention_kv_native_d32_bounded_softmax_table_envelope_from_json_slice(
    raw_json: &[u8],
) -> Result<ZkAiAttentionKvNativeD32BoundedSoftmaxTableEnvelope> {
    if raw_json.len() > ZKAI_ATTENTION_KV_NATIVE_D32_BOUNDED_SOFTMAX_TABLE_MAX_ENVELOPE_JSON_BYTES {
        return Err(weighted_error(format!(
    ...
    let envelope: ZkAiAttentionKvNativeD32BoundedSoftmaxTableEnvelope =
...
pub fn verify_zkai_attention_kv_native_d32_bounded_softmax_table_envelope(
    envelope: &ZkAiAttentionKvNativeD32BoundedSoftmaxTableEnvelope,
) -> Result<bool> {
    validate_envelope(envelope)?;
    verify_rows(&envelope.input, &envelope.proof)
}

fn validate_envelope(envelope: &ZkAiAttentionKvNativeD32BoundedSoftmaxTableEnvelope) -> Result<()> {
    ...
    if envelope.proof.len() > ZKAI_ATTENTION_KV_NATIVE_D32_BOUNDED_SOFTMAX_TABLE_MAX_PROOF_BYTES {
        return Err(weighted_error(format!(
...
fn validate_input(input: &ZkAiAttentionKvNativeD32BoundedSoftmaxTableProofInput) -> Result<()> {
    expect_eq(
        &input.schema,
...
pub(crate) fn validate_zkai_attention_kv_native_d32_bounded_softmax_table_input(
    input: &ZkAiAttentionKvNativeD32BoundedSoftmaxTableProofInput,
) -> Result<()> {
    validate_input(input)
}

fn validate_sequence(input: &ZkAiAttentionKvNativeD32BoundedSoftmaxTableProofInput) -> Result<()> {
    ...
    for (step_index, step) in input.input_steps.iter().enumerate() {
        ...
        let next_item = AttentionKvD32BoundedSoftmaxTableEntry {
        ...
        let scored: Vec<(AttentionKvD32BoundedSoftmaxTableEntry, i64)> = next_cache
            .iter()
            ...
            scored.iter().zip(weights.iter()).enumerate()
        {
            ...
            expected_rows.push(AttentionKvD32BoundedSoftmaxTableScoreRow {
...
fn validate_kv_entry(entry: &AttentionKvD32BoundedSoftmaxTableEntry) -> Result<()> {
...
fn validate_input_step(
    step: &AttentionKvD32BoundedSoftmaxTableInputStep,
    step_index: usize,
) -> Result<()> {
    expect_usize(
        step.token_position,
...
fn validate_score_row(
    row: &AttentionKvD32BoundedSoftmaxTableScoreRow,
...
fn prove_rows(input: &ZkAiAttentionKvNativeD32BoundedSoftmaxTableProofInput) -> Result<Vec<u8>> {
    validate_input(input)?;
        ...
        prove::<SimdBackend, Blake2sM31MerkleChannel>(&[&component], channel, commitment_scheme)
            .map_err(|error| {
                VmError::UnsupportedProof(format!(
                    "attention/KV native d32 bounded Softmax-table AIR proving failed: {error}"
                ))
            })?;
    serde_json::to_vec(&AttentionKvNativeD32BoundedSoftmaxTableProofPayload { stark_proof })
        .map_err(|error| VmError::Serialization(error.to_string()))
}
...
fn verify_rows(
    ...
    validate_input(input)?;
    let payload: AttentionKvNativeD32BoundedSoftmaxTableProofPayload =
    ...
    verify(&[&component], channel, commitment_scheme, stark_proof)
        ...
        .map_err(|error| {
            weighted_error(format!(
                "attention/KV native d32 bounded Softmax-table proof rejected: {error}"
            ))
        })
}
...
fn attention_component() -> FrameworkComponent<AttentionKvNativeD32BoundedSoftmaxTableEval> {
    FrameworkComponent::new(
        &mut TraceLocationAllocator::new_with_preprocessed_columns(&preprocessed_column_ids()),
        AttentionKvNativeD32BoundedSoftmaxTableEval,
        SecureField::zero(),
    )
}
...
fn padding_row(row_index: usize) -> AttentionKvD32BoundedSoftmaxTableScoreRow {
    AttentionKvD32BoundedSoftmaxTableScoreRow {
        row_index,
        step_index: 0,
        candidate_index: 0,
        token_position: 0,
...
fn column_ids() -> Vec<String> {
    ...
    .into_iter()
    .map(|suffix| format!("zkai/attention-kv/native-d32-bounded-softmax-table/{suffix}"))
    .collect::<Vec<_>>();
    for prefix in [
        "query",
        "key",
        ...
        for index in 0..width {
            ids.push(format!(
                "zkai/attention-kv/native-d32-bounded-softmax-table/{prefix}-{index:02}"
            ));
        }
    }
    for index in 0..SCORE_GAP_BITS {
        ids.push(format!(
            "zkai/attention-kv/native-d32-bounded-softmax-table/score-gap-bit-{index:02}"
        ));
    }
    for index in 0..CAUSAL_GAP_BITS {
        ids.push(format!(
            "zkai/attention-kv/native-d32-bounded-softmax-table/causal-gap-bit-{index:02}"
        ));
    }
    for index in 0..WEIGHT_BITS {
        ids.push(format!(
            "zkai/attention-kv/native-d32-bounded-softmax-table/weight-bit-{index:02}"
        ));
    }
    for dim in 0..VALUE_WIDTH {
        for index in 0..OUTPUT_REMAINDER_BITS {
            ids.push(format!(
                "zkai/attention-kv/native-d32-bounded-softmax-table/output-remainder-{dim:02}-bit-{index:02}"
            ));
        }
    }
    ids
...
fn expected_weight_table_entries() -> Vec<AttentionKvD32BoundedSoftmaxTableWeightEntry> {
    WEIGHT_TABLE
        .iter()
        .map(
            |(gap, weight)| AttentionKvD32BoundedSoftmaxTableWeightEntry {
                gap: *gap,
                weight: *weight,
            },
        )
...
fn validate_weight_table(table: &[AttentionKvD32BoundedSoftmaxTableWeightEntry]) -> Result<()> {
...
fn kv_commitment(cache: &[AttentionKvD32BoundedSoftmaxTableEntry], domain: &str) -> Result<String> {
    let material = cache
        .iter()
        .map(|entry| {
...
fn input_steps_commitment(steps: &[AttentionKvD32BoundedSoftmaxTableInputStep]) -> Result<String> {
    let material = steps
        .iter()
        .map(|step| {
...
fn rows_commitment(rows: &[AttentionKvD32BoundedSoftmaxTableScoreRow]) -> Result<String> {
...
fn score_row_material(row: &AttentionKvD32BoundedSoftmaxTableScoreRow) -> Vec<i64> {
    let mut out = vec![
...
fn weighted_error(message: impl Into<String>) -> VmError {
    VmError::InvalidConfig(format!(
        "attention/KV native d32 bounded Softmax-table proof: {}",
        message.into()
    ))
}
...
mod tests {
    ...
    fn input() -> ZkAiAttentionKvNativeD32BoundedSoftmaxTableProofInput {
        zkai_attention_kv_native_d32_bounded_softmax_table_input_from_json_str(INPUT_JSON)
            .expect("d32 bounded Softmax-table attention input")
    }

    #[test]
    fn attention_kv_native_d32_bounded_softmax_table_input_validates_checked_rows() {
        let input = input();
        ...
        assert_eq!(score_row_material_width(), 268);
        assert_eq!(
            input.attention_outputs[0],
            vec![
                1, -4, 1, -5, 0, 4, -1, 3, -2, 2, -3, 1, -4, 1, -5, 0, 4, -1, 3, -2, 2, -3, 1, -4,
                1, -5, 0, 4, -1, 3, -2, 2,
            ]
        );
        assert_eq!(
            ...
            vec![
                0, -3, 2, -1, -4, 1, -2, 3, 0, -3, 2, 0, -3, 2, -1, -4, 1, -2, 3, 0, -3, 2, 0, -3,
                2, -1, -4, 1, -2, 3, 0, -3,
            ]
        );
    ...
    #[test]
    fn attention_kv_native_d32_bounded_softmax_table_uses_floor_division_for_negative_numerators() {
        assert_eq!(
    ...
    #[test]
    fn attention_kv_native_d32_bounded_softmax_table_air_proof_round_trips() {
        let input = input();
        let envelope = prove_zkai_attention_kv_native_d32_bounded_softmax_table_envelope(&input)
            .expect("d32 bounded Softmax-table attention proof");
    ...
    #[test]
    fn attention_kv_native_d32_bounded_softmax_table_rejects_weight_relabeling() {
        let mut value: Value = serde_json::from_str(INPUT_JSON).expect("json");
        value["score_rows"][0]["attention_weight"] = Value::from(15);
        let error = zkai_attention_kv_native_d32_bounded_softmax_table_input_from_json_str(
    ...
    #[test]
    fn attention_kv_native_d32_bounded_softmax_table_rejects_table_relabeling() {
        let mut value: Value = serde_json::from_str(INPUT_JSON).expect("json");
    ...
    #[test]
    fn attention_kv_native_d32_bounded_softmax_table_rejects_output_relabeling() {
        let mut value: Value = serde_json::from_str(INPUT_JSON).expect("json");
    ...
    #[test]
    fn attention_kv_native_d32_bounded_softmax_table_rejects_quotient_remainder_drift() {
        let mut value: Value = serde_json::from_str(INPUT_JSON).expect("json");
    ...
    #[test]
    fn attention_kv_native_d32_bounded_softmax_table_rejects_commitment_drift() {
        let mut value: Value = serde_json::from_str(INPUT_JSON).expect("json");
    ...
    #[test]
    fn attention_kv_native_d32_bounded_softmax_table_rejects_proof_byte_tamper() {
        let input = input();
        let mut envelope =
        ...
        *last ^= 1;
        assert!(
            verify_zkai_attention_kv_native_d32_bounded_softmax_table_envelope(&envelope).is_err()
        );
    }

    #[test]
    fn attention_kv_native_d32_bounded_softmax_table_rejects_unknown_envelope_field() {
        let input = input();
        let envelope = prove_zkai_attention_kv_native_d32_bounded_softmax_table_envelope(&input)
            .expect("d32 bounded Softmax-table attention proof");

...
pub const ZKAI_ATTENTION_KV_NATIVE_D16_TWO_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_INPUT_SCHEMA: &str =
    "zkai-attention-kv-stwo-native-d16-two-head-longseq-bounded-softmax-table-air-proof-input-v1";
pub const ZKAI_ATTENTION_KV_NATIVE_D16_TWO_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_INPUT_DECISION: &str =
    "GO_INPUT_FOR_STWO_NATIVE_ATTENTION_KV_D16_TWO_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_AIR_PROOF";
pub const ZKAI_ATTENTION_KV_NATIVE_D16_TWO_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_PROOF_VERSION: &str =
    "stwo-attention-kv-d16-two-head-longseq-causal-mask-bounded-softmax-table-air-proof-v1";
pub const ZKAI_ATTENTION_KV_NATIVE_D16_TWO_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_STATEMENT_VERSION:
    &str = "zkai-attention-kv-stwo-native-d16-two-head-longseq-bounded-softmax-table-statement-v1";
pub const ZKAI_ATTENTION_KV_NATIVE_D16_TWO_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_SEMANTIC_SCOPE: &str =
    "d16_two_head_longseq_bounded_table_softmax_approx_attention_kv_causal_mask_rows_bound_to_statement_receipt";
pub const ZKAI_ATTENTION_KV_NATIVE_D16_TWO_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_DECISION: &str =
    "GO_STWO_NATIVE_ATTENTION_KV_D16_TWO_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_AIR_PROOF";
pub const ZKAI_ATTENTION_KV_NATIVE_D16_TWO_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_TARGET_ID: &str =
    "attention-kv-d16-two-head-longseq-causal-mask-bounded-softmax-table-v1";
pub const ZKAI_ATTENTION_KV_NATIVE_D16_TWO_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_REQUIRED_BACKEND_VERSION: &str =
    "stwo-attention-kv-d16-two-head-longseq-causal-mask-bounded-softmax-table-v1";
pub const ZKAI_ATTENTION_KV_NATIVE_D16_TWO_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_VERIFIER_DOMAIN:
    &str = "ptvm:zkai:attention-kv-stwo-native-d16-two-head-longseq-bounded-softmax-table:v1";

const ISSUE: usize = 525;
const SOURCE_ISSUE: usize = 521;
...
pub const ZKAI_ATTENTION_KV_NATIVE_D16_TWO_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_MAX_INPUT_JSON_BYTES:
    usize = 1_048_576;
pub const ZKAI_ATTENTION_KV_NATIVE_D16_TWO_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_MAX_ENVELOPE_JSON_BYTES: usize =
    2_097_152;
...
pub const ZKAI_ATTENTION_KV_NATIVE_D16_TWO_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_MAX_PROOF_BYTES:
    usize = 131_072;

const ROW_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d16-two-head-longseq-bounded-softmax-table-score-rows:v1";
const INITIAL_KV_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d16-two-head-longseq-bounded-softmax-table-initial-kv:v1";
const INPUT_STEPS_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d16-two-head-longseq-bounded-softmax-table-input-steps:v1";
const FINAL_KV_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d16-two-head-longseq-bounded-softmax-table-final-kv:v1";
const OUTPUTS_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d16-two-head-longseq-bounded-softmax-table-outputs:v1";
const PUBLIC_INSTANCE_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d16-two-head-longseq-bounded-softmax-table-public-instance:v1";
const PROOF_NATIVE_PARAMETER_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d16-two-head-longseq-bounded-softmax-table-proof-parameters:v1";
const WEIGHT_TABLE_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d16-two-head-longseq-bounded-softmax-table-weight-table:v1";
...
const NEXT_BACKEND_STEP: &str = "fuse the same d16 two-head long-sequence bounded Softmax-table arithmetic with LogUp table membership in one native Stwo proof";

const EXPECTED_VALIDATION_COMMANDS: &[&str] = &[
    "python3 scripts/zkai_attention_kv_stwo_native_d16_two_head_longseq_bounded_softmax_table_proof_input.py --write-json docs/engineering/evidence/zkai-attention-kv-stwo-native-d16-two-head-longseq-bounded-softmax-table-proof-2026-05.json --write-tsv docs/engineering/evidence/zkai-attention-kv-stwo-native-d16-two-head-longseq-bounded-softmax-table-proof-2026-05.tsv",
    ...
    "cargo +nightly-2025-07-14 test --locked attention_kv_native_d16_two_head_longseq_bounded_softmax_table_proof --lib --features stwo-backend",
    "cargo +nightly-2025-07-14 run --locked --features stwo-backend --bin zkai_attention_kv_native_d16_two_head_longseq_bounded_softmax_table_proof -- prove docs/engineering/evidence/zkai-attention-kv-stwo-native-d16-two-head-longseq-bounded-softmax-table-proof-2026-05.json docs/engineering/evidence/zkai-attention-kv-stwo-native-d16-two-head-longseq-bounded-softmax-table-proof-2026-05.envelope.json",
    "cargo +nightly-2025-07-14 run --locked --features stwo-backend --bin zkai_attention_kv_native_d16_two_head_longseq_bounded_softmax_table_proof -- verify docs/engineering/evidence/zkai-attention-kv-stwo-native-d16-two-head-longseq-bounded-softmax-table-proof-2026-05.envelope.json",
...
#[derive(Debug, Clone)]
struct AttentionKvNativeD16TwoHeadLongseqBoundedSoftmaxTableEval;

impl FrameworkEval for AttentionKvNativeD16TwoHeadLongseqBoundedSoftmaxTableEval {
...
pub struct AttentionKvD16TwoHeadLongseqBoundedSoftmaxTableEntry {
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct AttentionKvD16TwoHeadLongseqBoundedSoftmaxTableInputStep {
    pub head_index: usize,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct AttentionKvD16TwoHeadLongseqBoundedSoftmaxTableWeightEntry {
    pub gap: usize,
    pub weight: i64,
}
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct AttentionKvD16TwoHeadLongseqBoundedSoftmaxTableScoreRow {
    pub row_index: usize,
    pub head_index: usize,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct ZkAiAttentionKvNativeD16TwoHeadLongseqBoundedSoftmaxTableProofInput {
    pub schema: String,
    pub decision: String,
    pub issue: usize,
    ...
    pub weight_table: Vec<AttentionKvD16TwoHeadLongseqBoundedSoftmaxTableWeightEntry>,
    ...
    pub initial_kv_cache: Vec<AttentionKvD16TwoHeadLongseqBoundedSoftmaxTableEntry>,
    pub input_steps: Vec<AttentionKvD16TwoHeadLongseqBoundedSoftmaxTableInputStep>,
    pub final_kv_cache: Vec<AttentionKvD16TwoHeadLongseqBoundedSoftmaxTableEntry>,
    pub attention_outputs: Vec<Vec<i64>>,
    pub score_rows: Vec<AttentionKvD16TwoHeadLongseqBoundedSoftmaxTableScoreRow>,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct ZkAiAttentionKvNativeD16TwoHeadLongseqBoundedSoftmaxTableEnvelope {
    pub proof_backend: StarkProofBackend,
    pub proof_backend_version: String,
    pub statement_version: String,
    pub semantic_scope: String,
    pub decision: String,
    pub input: ZkAiAttentionKvNativeD16TwoHeadLongseqBoundedSoftmaxTableProofInput,
    pub proof: Vec<u8>,
}

#[derive(Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
struct AttentionKvNativeD16TwoHeadLongseqBoundedSoftmaxTableProofPayload {
    stark_proof: StarkProof<Blake2sM31MerkleHasher>,
}

pub fn zkai_attention_kv_native_d16_two_head_longseq_bounded_softmax_table_input_from_json_str(
    raw_json: &str,
) -> Result<ZkAiAttentionKvNativeD16TwoHeadLongseqBoundedSoftmaxTableProofInput> {
    if raw_json.len()
    ...
    let input: ZkAiAttentionKvNativeD16TwoHeadLongseqBoundedSoftmaxTableProofInput =
...
pub fn prove_zkai_attention_kv_native_d16_two_head_longseq_bounded_softmax_table_envelope(
    input: &ZkAiAttentionKvNativeD16TwoHeadLongseqBoundedSoftmaxTableProofInput,
) -> Result<ZkAiAttentionKvNativeD16TwoHeadLongseqBoundedSoftmaxTableEnvelope> {
    validate_input(input)?;
    Ok(ZkAiAttentionKvNativeD16TwoHeadLongseqBoundedSoftmaxTableEnvelope {
        proof_backend: StarkProofBackend::Stwo,
        proof_backend_version:
            ZKAI_ATTENTION_KV_NATIVE_D16_TWO_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_REQUIRED_BACKEND_VERSION
                .to_string(),
        statement_version:
            ZKAI_ATTENTION_KV_NATIVE_D16_TWO_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_STATEMENT_VERSION.to_string(),
        semantic_scope: ZKAI_ATTENTION_KV_NATIVE_D16_TWO_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_SEMANTIC_SCOPE
            .to_string(),
        decision: ZKAI_ATTENTION_KV_NATIVE_D16_TWO_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_DECISION.to_string(),
        input: input.clone(),
        proof: prove_rows(input)?,
    })
}

pub fn zkai_attention_kv_native_d16_two_head_longseq_bounded_softmax_table_envelope_from_json_slice(
    raw_json: &[u8],
) -> Result<ZkAiAttentionKvNativeD16TwoHeadLongseqBoundedSoftmaxTableEnvelope> {
    if raw_json.len()
    ...
    let envelope: ZkAiAttentionKvNativeD16TwoHeadLongseqBoundedSoftmaxTableEnvelope =
...
pub fn verify_zkai_attention_kv_native_d16_two_head_longseq_bounded_softmax_table_envelope(
    envelope: &ZkAiAttentionKvNativeD16TwoHeadLongseqBoundedSoftmaxTableEnvelope,
) -> Result<bool> {
    validate_envelope(envelope)?;
...
pub(crate) fn validate_zkai_attention_kv_native_d16_two_head_longseq_bounded_softmax_table_input(
    input: &ZkAiAttentionKvNativeD16TwoHeadLongseqBoundedSoftmaxTableProofInput,
) -> Result<()> {
    validate_input(input)
}
...
fn validate_sequence(
    ...
    for (global_step_index, step) in input.input_steps.iter().enumerate() {
        ...
        let next_item = AttentionKvD16TwoHeadLongseqBoundedSoftmaxTableEntry {
        ...
        let scored: Vec<(AttentionKvD16TwoHeadLongseqBoundedSoftmaxTableEntry, i64)> = next_cache
            .iter()
            .filter(|candidate| {
            ...
            scored.iter().zip(weights.iter()).enumerate()
        {
            ...
            expected_rows.push(AttentionKvD16TwoHeadLongseqBoundedSoftmaxTableScoreRow {
...
fn validate_per_head_strict_positions(
    entries: &[AttentionKvD16TwoHeadLongseqBoundedSoftmaxTableEntry],
    label: &str,
) -> Result<()> {
...
fn validate_final_kv_append_order(
    ...
    for step in &input.input_steps {
        expected.push(AttentionKvD16TwoHeadLongseqBoundedSoftmaxTableEntry {
            head_index: step.head_index,
            position: step.token_position,
            key: step.new_key.clone(),
            value: step.new_value.clone(),
...
fn validate_kv_entry(entry: &AttentionKvD16TwoHeadLongseqBoundedSoftmaxTableEntry) -> Result<()> {
    if entry.head_index >= HEAD_COUNT {
...
fn validate_input_step(
    step: &AttentionKvD16TwoHeadLongseqBoundedSoftmaxTableInputStep,
) -> Result<()> {
    if step.head_index >= HEAD_COUNT {
        return Err(weighted_error("input step head index out of range"));
    }
...
fn validate_score_row(
    row: &AttentionKvD16TwoHeadLongseqBoundedSoftmaxTableScoreRow,
        ...
        prove::<SimdBackend, Blake2sM31MerkleChannel>(&[&component], channel, commitment_scheme)
            .map_err(|error| {
                VmError::UnsupportedProof(format!(
                    "attention/KV native d16 two-head long-sequence bounded Softmax-table AIR proving failed: {error}"
                ))
            })?;
    serde_json::to_vec(
        &AttentionKvNativeD16TwoHeadLongseqBoundedSoftmaxTableProofPayload { stark_proof },
    )
    .map_err(|error| VmError::Serialization(error.to_string()))
}
...
fn verify_rows(
    ...
    validate_input(input)?;
    let payload: AttentionKvNativeD16TwoHeadLongseqBoundedSoftmaxTableProofPayload =
    ...
    verify(&[&component], channel, commitment_scheme, stark_proof)
        ...
        .map_err(|error| {
            weighted_error(format!(
                "attention/KV native d16 two-head long-sequence bounded Softmax-table proof rejected: {error}"
            ))
        })
}
...
) -> FrameworkComponent<AttentionKvNativeD16TwoHeadLongseqBoundedSoftmaxTableEval> {
    FrameworkComponent::new(
        &mut TraceLocationAllocator::new_with_preprocessed_columns(&preprocessed_column_ids()),
        AttentionKvNativeD16TwoHeadLongseqBoundedSoftmaxTableEval,
        SecureField::zero(),
    )
}
...
fn padding_row(row_index: usize) -> AttentionKvD16TwoHeadLongseqBoundedSoftmaxTableScoreRow {
...
fn column_ids() -> Vec<String> {
    ...
    .into_iter()
    .map(|suffix| {
        format!("zkai/attention-kv/native-d16-two-head-longseq-bounded-softmax-table/{suffix}")
    })
    .collect::<Vec<_>>();
    for prefix in [
        "query",
        ...
        for index in 0..width {
            ids.push(format!(
                "zkai/attention-kv/native-d16-two-head-longseq-bounded-softmax-table/{prefix}-{index:02}"
            ));
        }
    }
    for index in 0..SCORE_GAP_BITS {
        ids.push(format!(
            "zkai/attention-kv/native-d16-two-head-longseq-bounded-softmax-table/score-gap-bit-{index:02}"
        ));
    }
    for index in 0..CAUSAL_GAP_BITS {
        ids.push(format!(
            "zkai/attention-kv/native-d16-two-head-longseq-bounded-softmax-table/causal-gap-bit-{index:02}"
        ));
    }
    for index in 0..WEIGHT_BITS {
        ids.push(format!(
            "zkai/attention-kv/native-d16-two-head-longseq-bounded-softmax-table/weight-bit-{index:02}"
        ));
    }
    for dim in 0..VALUE_WIDTH {
        for index in 0..OUTPUT_REMAINDER_BITS {
            ids.push(format!(
                "zkai/attention-kv/native-d16-two-head-longseq-bounded-softmax-table/output-remainder-{dim:02}-bit-{index:02}"
            ));
        }
    }
    ids
...
fn expected_weight_table_entries() -> Vec<AttentionKvD16TwoHeadLongseqBoundedSoftmaxTableWeightEntry>
{
    WEIGHT_TABLE
        .iter()
        .map(
            |(gap, weight)| AttentionKvD16TwoHeadLongseqBoundedSoftmaxTableWeightEntry {
                gap: *gap,
                weight: *weight,
            },
        )
...
fn validate_weight_table(
    table: &[AttentionKvD16TwoHeadLongseqBoundedSoftmaxTableWeightEntry],
) -> Result<()> {
...
fn kv_commitment(
    cache: &[AttentionKvD16TwoHeadLongseqBoundedSoftmaxTableEntry],
    domain: &str,
) -> Result<String> {
    let material = cache
        .iter()
...
fn input_steps_commitment(
    steps: &[AttentionKvD16TwoHeadLongseqBoundedSoftmaxTableInputStep],
) -> Result<String> {
    let material = steps
        .iter()
        .map(|step| {
...
fn rows_commitment(
    rows: &[AttentionKvD16TwoHeadLongseqBoundedSoftmaxTableScoreRow],
) -> Result<String> {
    ...
    commitment_from_parts(
        &[
            (
                "encoding",
                json_string(
                    "attention_kv_stwo_native_d16_two_head_longseq_bounded_softmax_table_score_rows_v1",
                )?,
            ),
            (
                "shape",
...
fn score_row_material(row: &AttentionKvD16TwoHeadLongseqBoundedSoftmaxTableScoreRow) -> Vec<i64> {
    let mut out = vec![
...
fn weighted_error(message: impl Into<String>) -> VmError {
    VmError::InvalidConfig(format!(
        "attention/KV native d16 two-head long-sequence bounded Softmax-table proof: {}",
        message.into()
    ))
}
...
mod tests {
    ...
    fn input() -> ZkAiAttentionKvNativeD16TwoHeadLongseqBoundedSoftmaxTableProofInput {
        zkai_attention_kv_native_d16_two_head_longseq_bounded_softmax_table_input_from_json_str(
            INPUT_JSON,
        )
        .expect("d16 two-head long-sequence bounded Softmax-table attention input")
    }

    #[test]
    fn attention_kv_native_d16_two_head_longseq_bounded_softmax_table_input_validates_checked_rows()
    {
        let input = input();
        ...
        assert_eq!(
            ...
            vec![2, -4, 1, -5, 0, 4, -1, 3, -2, 2, -3, 2, -4, 1, -5, 0]
        );
        assert_eq!(
            input.attention_outputs[15],
            vec![-1, 1, -3, 3, 0, -3, -2, -1, 0, -3, 2, -1, 1, -3, 3, 0]
        );
    ...
    #[test]
    fn attention_kv_native_d16_two_head_longseq_bounded_softmax_table_uses_floor_division_for_negative_numerators(
    ) {
        assert_eq!(
    ...
    #[test]
    fn attention_kv_native_d16_two_head_longseq_bounded_softmax_table_air_proof_round_trips() {
        let input = input();
        let envelope =
            prove_zkai_attention_kv_native_d16_two_head_longseq_bounded_softmax_table_envelope(
                &input,
            )
            .expect("d16 two-head long-sequence bounded Softmax-table attention proof");
    ...
    #[test]
    fn attention_kv_native_d16_two_head_longseq_bounded_softmax_table_rejects_weight_relabeling() {
    ...
    #[test]
    fn attention_kv_native_d16_two_head_longseq_bounded_softmax_table_rejects_head_relabeling() {
        let mut value: Value = serde_json::from_str(INPUT_JSON).expect("json");
    ...
    #[test]
    fn attention_kv_native_d16_two_head_longseq_bounded_softmax_table_rejects_output_relabeling() {
        let mut value: Value = serde_json::from_str(INPUT_JSON).expect("json");
    ...
    #[test]
    fn attention_kv_native_d16_two_head_longseq_bounded_softmax_table_rejects_quotient_remainder_drift(
    ) {
        let mut value: Value = serde_json::from_str(INPUT_JSON).expect("json");
    ...
    #[test]
    fn attention_kv_native_d16_two_head_longseq_bounded_softmax_table_rejects_initial_kv_position_reorder(
    ) {
        let mut input = input();
    ...
    #[test]
    fn attention_kv_native_d16_two_head_longseq_bounded_softmax_table_rejects_final_kv_append_reorder(
    ) {
        let mut input = input();
    ...
    #[test]
    fn attention_kv_native_d16_two_head_longseq_bounded_softmax_table_rejects_commitment_drift() {
        let mut value: Value = serde_json::from_str(INPUT_JSON).expect("json");
    ...
    #[test]
    fn attention_kv_native_d16_two_head_longseq_bounded_softmax_table_rejects_proof_byte_tamper() {
        let input = input();
        let mut envelope =
            prove_zkai_attention_kv_native_d16_two_head_longseq_bounded_softmax_table_envelope(
                &input,
    ...
    #[test]
    fn attention_kv_native_d16_two_head_longseq_bounded_softmax_table_rejects_unknown_envelope_field(
    ) {
        let input = input();
        let envelope =
            prove_zkai_attention_kv_native_d16_two_head_longseq_bounded_softmax_table_envelope(
        ...
        let error =
            zkai_attention_kv_native_d16_two_head_longseq_bounded_softmax_table_envelope_from_json_slice(&raw)
                .unwrap_err();

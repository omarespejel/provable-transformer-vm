...
pub const ZKAI_ATTENTION_KV_NATIVE_D128_FOUR_HEAD_SEQ32_BOUNDED_SOFTMAX_TABLE_INPUT_SCHEMA: &str =
    "zkai-attention-kv-stwo-native-d128-four-head-seq32-bounded-softmax-table-air-proof-input-v1";
pub const ZKAI_ATTENTION_KV_NATIVE_D128_FOUR_HEAD_SEQ32_BOUNDED_SOFTMAX_TABLE_INPUT_DECISION: &str =
    "GO_INPUT_FOR_STWO_NATIVE_ATTENTION_KV_D128_FOUR_HEAD_SEQ32_BOUNDED_SOFTMAX_TABLE_AIR_PROOF";
pub const ZKAI_ATTENTION_KV_NATIVE_D128_FOUR_HEAD_SEQ32_BOUNDED_SOFTMAX_TABLE_PROOF_VERSION: &str =
    "stwo-attention-kv-d128-four-head-seq32-causal-mask-bounded-softmax-table-air-proof-v1";
pub const ZKAI_ATTENTION_KV_NATIVE_D128_FOUR_HEAD_SEQ32_BOUNDED_SOFTMAX_TABLE_STATEMENT_VERSION:
    &str = "zkai-attention-kv-stwo-native-d128-four-head-seq32-bounded-softmax-table-statement-v1";
pub const ZKAI_ATTENTION_KV_NATIVE_D128_FOUR_HEAD_SEQ32_BOUNDED_SOFTMAX_TABLE_SEMANTIC_SCOPE: &str =
    "d128_four_head_seq32_bounded_table_softmax_approx_attention_kv_causal_mask_rows_bound_to_statement_receipt";
pub const ZKAI_ATTENTION_KV_NATIVE_D128_FOUR_HEAD_SEQ32_BOUNDED_SOFTMAX_TABLE_DECISION: &str =
    "GO_STWO_NATIVE_ATTENTION_KV_D128_FOUR_HEAD_SEQ32_BOUNDED_SOFTMAX_TABLE_AIR_PROOF";
pub const ZKAI_ATTENTION_KV_NATIVE_D128_FOUR_HEAD_SEQ32_BOUNDED_SOFTMAX_TABLE_TARGET_ID: &str =
    "attention-kv-d128-four-head-seq32-causal-mask-bounded-softmax-table-v1";
pub const ZKAI_ATTENTION_KV_NATIVE_D128_FOUR_HEAD_SEQ32_BOUNDED_SOFTMAX_TABLE_REQUIRED_BACKEND_VERSION:
    &str = "stwo-attention-kv-d128-four-head-seq32-causal-mask-bounded-softmax-table-v1";
pub const ZKAI_ATTENTION_KV_NATIVE_D128_FOUR_HEAD_SEQ32_BOUNDED_SOFTMAX_TABLE_VERIFIER_DOMAIN:
    &str = "ptvm:zkai:attention-kv-stwo-native-d128-four-head-seq32-bounded-softmax-table:v1";
...
pub const ZKAI_ATTENTION_KV_NATIVE_D128_FOUR_HEAD_SEQ32_BOUNDED_SOFTMAX_TABLE_MAX_INPUT_JSON_BYTES:
    usize = 134_217_728;
pub const ZKAI_ATTENTION_KV_NATIVE_D128_FOUR_HEAD_SEQ32_BOUNDED_SOFTMAX_TABLE_MAX_ENVELOPE_JSON_BYTES:
    usize = 268_435_456;
...
pub const ZKAI_ATTENTION_KV_NATIVE_D128_FOUR_HEAD_SEQ32_BOUNDED_SOFTMAX_TABLE_MAX_PROOF_BYTES:
    usize = 1_048_576;

const ROW_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d128-four-head-seq32-bounded-softmax-table-score-rows:v1";
const INITIAL_KV_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d128-four-head-seq32-bounded-softmax-table-initial-kv:v1";
const INPUT_STEPS_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d128-four-head-seq32-bounded-softmax-table-input-steps:v1";
const FINAL_KV_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d128-four-head-seq32-bounded-softmax-table-final-kv:v1";
const OUTPUTS_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d128-four-head-seq32-bounded-softmax-table-outputs:v1";
const PUBLIC_INSTANCE_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d128-four-head-seq32-bounded-softmax-table-public-instance:v1";
const PROOF_NATIVE_PARAMETER_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d128-four-head-seq32-bounded-softmax-table-proof-parameters:v1";
const WEIGHT_TABLE_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d128-four-head-seq32-bounded-softmax-table-weight-table:v1";
...
const NEXT_BACKEND_STEP: &str = "fuse the same d128 four-head seq32 bounded Softmax-table arithmetic with LogUp table membership in one native Stwo proof";

const EXPECTED_VALIDATION_COMMANDS: &[&str] = &[
    "python3.10 scripts/zkai_attention_kv_stwo_native_d128_four_head_seq32_bounded_softmax_table_proof_input.py --write-json docs/engineering/evidence/zkai-attention-kv-stwo-native-d128-four-head-seq32-bounded-softmax-table-proof-2026-05.json --write-tsv docs/engineering/evidence/zkai-attention-kv-stwo-native-d128-four-head-seq32-bounded-softmax-table-proof-2026-05.tsv",
    ...
    "cargo +nightly-2025-07-14 test --locked attention_kv_native_d128_four_head_seq32_bounded_softmax_table_proof --lib --features stwo-backend",
    "cargo +nightly-2025-07-14 run --locked --features stwo-backend --bin zkai_attention_kv_native_d128_four_head_seq32_bounded_softmax_table_proof -- prove docs/engineering/evidence/zkai-attention-kv-stwo-native-d128-four-head-seq32-bounded-softmax-table-proof-2026-05.json docs/engineering/evidence/zkai-attention-kv-stwo-native-d128-four-head-seq32-bounded-softmax-table-proof-2026-05.envelope.json",
    ...
    "cargo +nightly-2025-07-14 test --locked attention_kv_d128_four_head_seq32_softmax_table_lookup --lib --features stwo-backend",
    "cargo +nightly-2025-07-14 run --locked --features stwo-backend --bin zkai_attention_kv_native_d128_four_head_seq32_softmax_table_lookup_proof -- prove docs/engineering/evidence/zkai-attention-kv-stwo-native-d128-four-head-seq32-bounded-softmax-table-proof-2026-05.json docs/engineering/evidence/zkai-attention-kv-stwo-native-d128-four-head-seq32-softmax-table-logup-sidecar-proof-2026-05.envelope.json",
    ...
    "python3.10 scripts/zkai_attention_kv_d128_four_head_seq32_air_private_softmax_table_lookup_gate.py --write-json docs/engineering/evidence/zkai-attention-kv-stwo-native-d128-four-head-seq32-softmax-table-logup-sidecar-gate-2026-05.json --write-tsv docs/engineering/evidence/zkai-attention-kv-stwo-native-d128-four-head-seq32-softmax-table-logup-sidecar-gate-2026-05.tsv",
    "python3.10 -m unittest scripts.tests.test_zkai_attention_kv_d128_four_head_seq32_air_private_softmax_table_lookup_gate",
    "python3.10 scripts/zkai_attention_kv_d128_four_head_seq32_fused_softmax_table_native_gate.py --write-json docs/engineering/evidence/zkai-attention-kv-stwo-native-d128-four-head-seq32-fused-softmax-table-gate-2026-05.json --write-tsv docs/engineering/evidence/zkai-attention-kv-stwo-native-d128-four-head-seq32-fused-softmax-table-gate-2026-05.tsv",
...
#[derive(Debug, Clone)]
struct AttentionKvNativeD128FourHeadSeq32BoundedSoftmaxTableEval;

#[derive(Default)]
struct AttentionKvD128FourHeadSeq32BoundedSoftmaxTableLayoutCounter {
    trace_masks: usize,
    preprocessed_masks: usize,
}

impl EvalAtRow for AttentionKvD128FourHeadSeq32BoundedSoftmaxTableLayoutCounter {
    type F = BaseField;
    type EF = SecureField;
...
impl FrameworkEval for AttentionKvNativeD128FourHeadSeq32BoundedSoftmaxTableEval {
...
pub struct AttentionKvD128FourHeadSeq32BoundedSoftmaxTableEntry {
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct AttentionKvD128FourHeadSeq32BoundedSoftmaxTableInputStep {
    pub head_index: usize,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct AttentionKvD128FourHeadSeq32BoundedSoftmaxTableWeightEntry {
    pub gap: usize,
    pub weight: i64,
}
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct AttentionKvD128FourHeadSeq32BoundedSoftmaxTableScoreRow {
    pub row_index: usize,
    pub head_index: usize,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct ZkAiAttentionKvNativeD128FourHeadSeq32BoundedSoftmaxTableProofInput {
    pub schema: String,
    pub decision: String,
    pub issue: usize,
    ...
    pub weight_table: Vec<AttentionKvD128FourHeadSeq32BoundedSoftmaxTableWeightEntry>,
    ...
    pub initial_kv_cache: Vec<AttentionKvD128FourHeadSeq32BoundedSoftmaxTableEntry>,
    pub input_steps: Vec<AttentionKvD128FourHeadSeq32BoundedSoftmaxTableInputStep>,
    pub final_kv_cache: Vec<AttentionKvD128FourHeadSeq32BoundedSoftmaxTableEntry>,
    pub attention_outputs: Vec<Vec<i64>>,
    pub score_rows: Vec<AttentionKvD128FourHeadSeq32BoundedSoftmaxTableScoreRow>,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct ZkAiAttentionKvNativeD128FourHeadSeq32BoundedSoftmaxTableEnvelope {
    pub proof_backend: StarkProofBackend,
    pub proof_backend_version: String,
    pub statement_version: String,
    pub semantic_scope: String,
    pub decision: String,
    pub input: ZkAiAttentionKvNativeD128FourHeadSeq32BoundedSoftmaxTableProofInput,
    pub proof: Vec<u8>,
}

#[derive(Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
struct AttentionKvNativeD128FourHeadSeq32BoundedSoftmaxTableProofPayload {
    stark_proof: StarkProof<Blake2sM31MerkleHasher>,
}

pub fn zkai_attention_kv_native_d128_four_head_seq32_bounded_softmax_table_input_from_json_str(
    raw_json: &str,
) -> Result<ZkAiAttentionKvNativeD128FourHeadSeq32BoundedSoftmaxTableProofInput> {
    if raw_json.len()
    ...
    let input: ZkAiAttentionKvNativeD128FourHeadSeq32BoundedSoftmaxTableProofInput =
...
pub fn prove_zkai_attention_kv_native_d128_four_head_seq32_bounded_softmax_table_envelope(
    input: &ZkAiAttentionKvNativeD128FourHeadSeq32BoundedSoftmaxTableProofInput,
) -> Result<ZkAiAttentionKvNativeD128FourHeadSeq32BoundedSoftmaxTableEnvelope> {
    validate_input(input)?;
    Ok(ZkAiAttentionKvNativeD128FourHeadSeq32BoundedSoftmaxTableEnvelope {
        proof_backend: StarkProofBackend::Stwo,
        proof_backend_version:
            ZKAI_ATTENTION_KV_NATIVE_D128_FOUR_HEAD_SEQ32_BOUNDED_SOFTMAX_TABLE_REQUIRED_BACKEND_VERSION
                .to_string(),
        statement_version:
            ZKAI_ATTENTION_KV_NATIVE_D128_FOUR_HEAD_SEQ32_BOUNDED_SOFTMAX_TABLE_STATEMENT_VERSION
                .to_string(),
        semantic_scope: ZKAI_ATTENTION_KV_NATIVE_D128_FOUR_HEAD_SEQ32_BOUNDED_SOFTMAX_TABLE_SEMANTIC_SCOPE
            .to_string(),
        decision: ZKAI_ATTENTION_KV_NATIVE_D128_FOUR_HEAD_SEQ32_BOUNDED_SOFTMAX_TABLE_DECISION.to_string(),
        input: input.clone(),
        proof: prove_rows(input)?,
    })
}

pub fn zkai_attention_kv_native_d128_four_head_seq32_bounded_softmax_table_envelope_from_json_slice(
    raw_json: &[u8],
) -> Result<ZkAiAttentionKvNativeD128FourHeadSeq32BoundedSoftmaxTableEnvelope> {
    if raw_json.len()
    ...
    let envelope: ZkAiAttentionKvNativeD128FourHeadSeq32BoundedSoftmaxTableEnvelope =
...
pub fn verify_zkai_attention_kv_native_d128_four_head_seq32_bounded_softmax_table_envelope(
    envelope: &ZkAiAttentionKvNativeD128FourHeadSeq32BoundedSoftmaxTableEnvelope,
) -> Result<bool> {
    validate_envelope(envelope)?;
...
fn validate_envelope(
    ...
    expect_eq(
        ...
        ZKAI_ATTENTION_KV_NATIVE_D128_FOUR_HEAD_SEQ32_BOUNDED_SOFTMAX_TABLE_SEMANTIC_SCOPE,
        "semantic scope",
    )?;
    expect_eq(
        &envelope.decision,
        ZKAI_ATTENTION_KV_NATIVE_D128_FOUR_HEAD_SEQ32_BOUNDED_SOFTMAX_TABLE_DECISION,
        "decision",
    )?;
    ...
    if envelope.proof.len()
        > ZKAI_ATTENTION_KV_NATIVE_D128_FOUR_HEAD_SEQ32_BOUNDED_SOFTMAX_TABLE_MAX_PROOF_BYTES
    {
        return Err(weighted_error(format!(
...
fn validate_input(
    ...
    expect_eq(
        &input.schema,
        ZKAI_ATTENTION_KV_NATIVE_D128_FOUR_HEAD_SEQ32_BOUNDED_SOFTMAX_TABLE_INPUT_SCHEMA,
        "schema",
    )?;
    expect_eq(
        &input.decision,
        ZKAI_ATTENTION_KV_NATIVE_D128_FOUR_HEAD_SEQ32_BOUNDED_SOFTMAX_TABLE_INPUT_DECISION,
        "input decision",
    )?;
    ...
    expect_eq(
        &input.target_id,
        ZKAI_ATTENTION_KV_NATIVE_D128_FOUR_HEAD_SEQ32_BOUNDED_SOFTMAX_TABLE_TARGET_ID,
        "target id",
    )?;
    expect_eq(
    ...
    expect_eq(
        &input.proof_version,
        ZKAI_ATTENTION_KV_NATIVE_D128_FOUR_HEAD_SEQ32_BOUNDED_SOFTMAX_TABLE_PROOF_VERSION,
        "proof version",
    )?;
    expect_eq(
    ...
    expect_eq(
        ...
        ZKAI_ATTENTION_KV_NATIVE_D128_FOUR_HEAD_SEQ32_BOUNDED_SOFTMAX_TABLE_VERIFIER_DOMAIN,
        "verifier domain",
    )?;
...
pub(crate) fn validate_zkai_attention_kv_native_d128_four_head_seq32_bounded_softmax_table_input(
    input: &ZkAiAttentionKvNativeD128FourHeadSeq32BoundedSoftmaxTableProofInput,
) -> Result<()> {
    validate_input(input)
}
...
fn validate_sequence(
    ...
    for (global_step_index, step) in input.input_steps.iter().enumerate() {
        ...
        let next_item = AttentionKvD128FourHeadSeq32BoundedSoftmaxTableEntry {
        ...
        let scored: Vec<(AttentionKvD128FourHeadSeq32BoundedSoftmaxTableEntry, i64)> = next_cache
            .iter()
            .filter(|candidate| {
            ...
            scored.iter().zip(weights.iter()).enumerate()
        {
            ...
            expected_rows.push(AttentionKvD128FourHeadSeq32BoundedSoftmaxTableScoreRow {
...
fn validate_per_head_strict_positions(
    entries: &[AttentionKvD128FourHeadSeq32BoundedSoftmaxTableEntry],
    label: &str,
) -> Result<()> {
...
fn validate_final_kv_append_order(
    ...
    for step in &input.input_steps {
        expected.push(AttentionKvD128FourHeadSeq32BoundedSoftmaxTableEntry {
            head_index: step.head_index,
            position: step.token_position,
            key: step.new_key.clone(),
            value: step.new_value.clone(),
...
fn validate_kv_entry(entry: &AttentionKvD128FourHeadSeq32BoundedSoftmaxTableEntry) -> Result<()> {
    if entry.head_index >= HEAD_COUNT {
...
fn validate_input_step(
    step: &AttentionKvD128FourHeadSeq32BoundedSoftmaxTableInputStep,
) -> Result<()> {
    if step.head_index >= HEAD_COUNT {
        return Err(weighted_error("input step head index out of range"));
    }
...
fn validate_score_row(
    row: &AttentionKvD128FourHeadSeq32BoundedSoftmaxTableScoreRow,
...
fn prove_rows(
    ...
    serde_json::to_vec(
        &AttentionKvNativeD128FourHeadSeq32BoundedSoftmaxTableProofPayload { stark_proof },
    )
    .map_err(|error| VmError::Serialization(error.to_string()))
}
...
fn verify_rows(
    ...
    validate_input(input)?;
    validate_static_air_layout()?;
    let payload: AttentionKvNativeD128FourHeadSeq32BoundedSoftmaxTableProofPayload =
...
) -> FrameworkComponent<AttentionKvNativeD128FourHeadSeq32BoundedSoftmaxTableEval> {
    FrameworkComponent::new(
        &mut TraceLocationAllocator::new_with_preprocessed_columns(&preprocessed_column_ids()),
        AttentionKvNativeD128FourHeadSeq32BoundedSoftmaxTableEval,
        SecureField::zero(),
    )
}
...
fn validate_static_air_layout() -> Result<()> {
    ...
    let counter = AttentionKvNativeD128FourHeadSeq32BoundedSoftmaxTableEval
        .evaluate(AttentionKvD128FourHeadSeq32BoundedSoftmaxTableLayoutCounter::default());
...
fn padding_row(row_index: usize) -> AttentionKvD128FourHeadSeq32BoundedSoftmaxTableScoreRow {
    AttentionKvD128FourHeadSeq32BoundedSoftmaxTableScoreRow {
        row_index,
        head_index: 0,
        step_index: 0,
        candidate_index: 0,
...
fn column_ids() -> Vec<String> {
    ...
    .into_iter()
    .map(|suffix| {
        format!("zkai/attention-kv/native-d128-four-head-seq32-bounded-softmax-table/{suffix}")
    })
    .collect::<Vec<_>>();
    for prefix in [
        "query",
        ...
        for index in 0..width {
            ids.push(format!(
                "zkai/attention-kv/native-d128-four-head-seq32-bounded-softmax-table/{prefix}-{index:02}"
            ));
        }
    }
    for index in 0..SCORE_GAP_BITS {
        ids.push(format!(
            "zkai/attention-kv/native-d128-four-head-seq32-bounded-softmax-table/score-gap-bit-{index:02}"
        ));
    }
    for index in 0..CAUSAL_GAP_BITS {
        ids.push(format!(
            "zkai/attention-kv/native-d128-four-head-seq32-bounded-softmax-table/causal-gap-bit-{index:02}"
        ));
    }
    for index in 0..WEIGHT_BITS {
        ids.push(format!(
            "zkai/attention-kv/native-d128-four-head-seq32-bounded-softmax-table/weight-bit-{index:02}"
        ));
    }
    for dim in 0..VALUE_WIDTH {
        for index in 0..OUTPUT_REMAINDER_BITS {
            ids.push(format!(
                "zkai/attention-kv/native-d128-four-head-seq32-bounded-softmax-table/output-remainder-{dim:02}-bit-{index:02}"
            ));
        }
    }
    ids
...
fn expected_weight_table_entries() -> Vec<AttentionKvD128FourHeadSeq32BoundedSoftmaxTableWeightEntry>
{
    WEIGHT_TABLE
        .iter()
        .map(
            |(gap, weight)| AttentionKvD128FourHeadSeq32BoundedSoftmaxTableWeightEntry {
                gap: *gap,
                weight: *weight,
            },
        )
...
fn validate_weight_table(
    table: &[AttentionKvD128FourHeadSeq32BoundedSoftmaxTableWeightEntry],
) -> Result<()> {
...
fn kv_commitment(
    cache: &[AttentionKvD128FourHeadSeq32BoundedSoftmaxTableEntry],
    domain: &str,
) -> Result<String> {
    let material = cache
        .iter()
...
fn input_steps_commitment(
    steps: &[AttentionKvD128FourHeadSeq32BoundedSoftmaxTableInputStep],
) -> Result<String> {
    let material = steps
        .iter()
        .map(|step| {
...
fn rows_commitment(
    rows: &[AttentionKvD128FourHeadSeq32BoundedSoftmaxTableScoreRow],
) -> Result<String> {
    ...
    commitment_from_parts(
        &[
            (
                "encoding",
                json_string(
                    "attention_kv_stwo_native_d128_four_head_seq32_bounded_softmax_table_score_rows_v1",
                )?,
            ),
            (
                "shape",
...
fn score_row_material(row: &AttentionKvD128FourHeadSeq32BoundedSoftmaxTableScoreRow) -> Vec<i64> {
    let mut out = vec![
...
mod tests {
    ...
    const INPUT_JSON: &str = include_str!(
        "../../docs/engineering/evidence/zkai-attention-kv-stwo-native-d128-four-head-seq32-bounded-softmax-table-proof-2026-05.json"
    );

    fn input() -> ZkAiAttentionKvNativeD128FourHeadSeq32BoundedSoftmaxTableProofInput {
    ...
    #[test]
    fn attention_kv_native_d128_four_head_seq32_bounded_softmax_table_input_validates_checked_rows()
    {
        let input = input();
    ...
    #[test]
    fn attention_kv_native_d128_four_head_seq32_bounded_softmax_table_uses_floor_division_for_negative_numerators(
    ) {
        assert_eq!(
    ...
    #[test]
    fn attention_kv_native_d128_four_head_seq32_bounded_softmax_table_air_proof_round_trips() {
        let input = input();
        let envelope =
    ...
    #[test]
    fn attention_kv_native_d128_four_head_seq32_bounded_softmax_table_rejects_weight_relabeling() {
    ...
    #[test]
    fn attention_kv_native_d128_four_head_seq32_bounded_softmax_table_rejects_head_relabeling() {
        let mut value: Value = serde_json::from_str(INPUT_JSON).expect("json");
    ...
    #[test]
    fn attention_kv_native_d128_four_head_seq32_bounded_softmax_table_rejects_output_relabeling() {
        let mut value: Value = serde_json::from_str(INPUT_JSON).expect("json");
    ...
    #[test]
    fn attention_kv_native_d128_four_head_seq32_bounded_softmax_table_rejects_quotient_remainder_drift(
    ) {
        let mut value: Value = serde_json::from_str(INPUT_JSON).expect("json");
    ...
    #[test]
    fn attention_kv_native_d128_four_head_seq32_bounded_softmax_table_rejects_initial_kv_position_reorder(
    ) {
        let mut input = input();
    ...
    #[test]
    fn attention_kv_native_d128_four_head_seq32_bounded_softmax_table_rejects_final_kv_append_reorder(
    ) {
        let mut input = input();
    ...
    #[test]
    fn attention_kv_native_d128_four_head_seq32_bounded_softmax_table_rejects_commitment_drift() {
        let mut value: Value = serde_json::from_str(INPUT_JSON).expect("json");
    ...
    #[test]
    fn attention_kv_native_d128_four_head_seq32_bounded_softmax_table_rejects_proof_byte_tamper() {
        let input = input();
        let mut envelope =
            prove_zkai_attention_kv_native_d128_four_head_seq32_bounded_softmax_table_envelope(
                &input,
    ...
    #[test]
    fn attention_kv_native_d128_four_head_seq32_bounded_softmax_table_rejects_unknown_envelope_field(
    ) {
        let input = input();
        let envelope =
            prove_zkai_attention_kv_native_d128_four_head_seq32_bounded_softmax_table_envelope(

...
pub const ZKAI_ATTENTION_KV_NATIVE_D32_TWO_HEAD_BOUNDED_SOFTMAX_TABLE_INPUT_SCHEMA: &str =
    "zkai-attention-kv-stwo-native-d32-two-head-bounded-softmax-table-air-proof-input-v1";
pub const ZKAI_ATTENTION_KV_NATIVE_D32_TWO_HEAD_BOUNDED_SOFTMAX_TABLE_INPUT_DECISION: &str =
    "GO_INPUT_FOR_STWO_NATIVE_ATTENTION_KV_D32_TWO_HEAD_BOUNDED_SOFTMAX_TABLE_AIR_PROOF";
pub const ZKAI_ATTENTION_KV_NATIVE_D32_TWO_HEAD_BOUNDED_SOFTMAX_TABLE_PROOF_VERSION: &str =
    "stwo-attention-kv-d32-two-head-causal-mask-bounded-softmax-table-air-proof-v1";
pub const ZKAI_ATTENTION_KV_NATIVE_D32_TWO_HEAD_BOUNDED_SOFTMAX_TABLE_STATEMENT_VERSION: &str =
    "zkai-attention-kv-stwo-native-d32-two-head-bounded-softmax-table-statement-v1";
pub const ZKAI_ATTENTION_KV_NATIVE_D32_TWO_HEAD_BOUNDED_SOFTMAX_TABLE_SEMANTIC_SCOPE: &str =
    "d32_two_head_bounded_table_softmax_approx_attention_kv_causal_mask_rows_bound_to_statement_receipt";
pub const ZKAI_ATTENTION_KV_NATIVE_D32_TWO_HEAD_BOUNDED_SOFTMAX_TABLE_DECISION: &str =
    "GO_STWO_NATIVE_ATTENTION_KV_D32_TWO_HEAD_BOUNDED_SOFTMAX_TABLE_AIR_PROOF";
pub const ZKAI_ATTENTION_KV_NATIVE_D32_TWO_HEAD_BOUNDED_SOFTMAX_TABLE_TARGET_ID: &str =
    "attention-kv-d32-two-head-causal-mask-bounded-softmax-table-v1";
pub const ZKAI_ATTENTION_KV_NATIVE_D32_TWO_HEAD_BOUNDED_SOFTMAX_TABLE_REQUIRED_BACKEND_VERSION:
    &str = "stwo-attention-kv-d32-two-head-causal-mask-bounded-softmax-table-v1";
pub const ZKAI_ATTENTION_KV_NATIVE_D32_TWO_HEAD_BOUNDED_SOFTMAX_TABLE_VERIFIER_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d32-two-head-bounded-softmax-table:v1";
...
pub const ZKAI_ATTENTION_KV_NATIVE_D32_TWO_HEAD_BOUNDED_SOFTMAX_TABLE_MAX_INPUT_JSON_BYTES: usize =
    2_097_152;
pub const ZKAI_ATTENTION_KV_NATIVE_D32_TWO_HEAD_BOUNDED_SOFTMAX_TABLE_MAX_ENVELOPE_JSON_BYTES:
    usize = 4_194_304;
...
pub const ZKAI_ATTENTION_KV_NATIVE_D32_TWO_HEAD_BOUNDED_SOFTMAX_TABLE_MAX_PROOF_BYTES: usize =
    262_144;

const ROW_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d32-two-head-bounded-softmax-table-score-rows:v1";
const INITIAL_KV_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d32-two-head-bounded-softmax-table-initial-kv:v1";
const INPUT_STEPS_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d32-two-head-bounded-softmax-table-input-steps:v1";
const FINAL_KV_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d32-two-head-bounded-softmax-table-final-kv:v1";
const OUTPUTS_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d32-two-head-bounded-softmax-table-outputs:v1";
const PUBLIC_INSTANCE_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d32-two-head-bounded-softmax-table-public-instance:v1";
const PROOF_NATIVE_PARAMETER_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d32-two-head-bounded-softmax-table-proof-parameters:v1";
const WEIGHT_TABLE_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d32-two-head-bounded-softmax-table-weight-table:v1";
...
const NEXT_BACKEND_STEP: &str = "combine bounded Softmax-table attention with d32-two-head state binding only after preserving weighted-product, quotient/remainder, carry, mask, and relabeling rejection surfaces";
...
pub struct AttentionKvD32TwoHeadBoundedSoftmaxTableEntry {
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct AttentionKvD32TwoHeadBoundedSoftmaxTableInputStep {
    pub head_index: usize,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct AttentionKvD32TwoHeadBoundedSoftmaxTableWeightEntry {
    pub gap: usize,
    pub weight: i64,
}
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct AttentionKvD32TwoHeadBoundedSoftmaxTableScoreRow {
    pub row_index: usize,
    pub head_index: usize,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct ZkAiAttentionKvNativeD32TwoHeadBoundedSoftmaxTableProofInput {
    pub schema: String,
    pub decision: String,
    pub issue: usize,
    ...
    pub weight_table: Vec<AttentionKvD32TwoHeadBoundedSoftmaxTableWeightEntry>,
    ...
    pub initial_kv_cache: Vec<AttentionKvD32TwoHeadBoundedSoftmaxTableEntry>,
    pub input_steps: Vec<AttentionKvD32TwoHeadBoundedSoftmaxTableInputStep>,
    pub final_kv_cache: Vec<AttentionKvD32TwoHeadBoundedSoftmaxTableEntry>,
    pub attention_outputs: Vec<Vec<i64>>,
    pub score_rows: Vec<AttentionKvD32TwoHeadBoundedSoftmaxTableScoreRow>,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct ZkAiAttentionKvNativeD32TwoHeadBoundedSoftmaxTableEnvelope {
    pub proof_backend: StarkProofBackend,
    pub proof_backend_version: String,
    pub statement_version: String,
    pub semantic_scope: String,
    pub decision: String,
    pub input: ZkAiAttentionKvNativeD32TwoHeadBoundedSoftmaxTableProofInput,
    pub proof: Vec<u8>,
}

#[derive(Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
struct AttentionKvNativeD32TwoHeadBoundedSoftmaxTableProofPayload {
    stark_proof: StarkProof<Blake2sM31MerkleHasher>,
}

pub fn zkai_attention_kv_native_d32_two_head_bounded_softmax_table_input_from_json_str(
    raw_json: &str,
) -> Result<ZkAiAttentionKvNativeD32TwoHeadBoundedSoftmaxTableProofInput> {
    if raw_json.len()
    ...
    let input: ZkAiAttentionKvNativeD32TwoHeadBoundedSoftmaxTableProofInput =
...
pub fn prove_zkai_attention_kv_native_d32_two_head_bounded_softmax_table_envelope(
    input: &ZkAiAttentionKvNativeD32TwoHeadBoundedSoftmaxTableProofInput,
) -> Result<ZkAiAttentionKvNativeD32TwoHeadBoundedSoftmaxTableEnvelope> {
    validate_input(input)?;
    Ok(ZkAiAttentionKvNativeD32TwoHeadBoundedSoftmaxTableEnvelope {
        proof_backend: StarkProofBackend::Stwo,
        proof_backend_version:
            ZKAI_ATTENTION_KV_NATIVE_D32_TWO_HEAD_BOUNDED_SOFTMAX_TABLE_REQUIRED_BACKEND_VERSION
                .to_string(),
        statement_version:
            ZKAI_ATTENTION_KV_NATIVE_D32_TWO_HEAD_BOUNDED_SOFTMAX_TABLE_STATEMENT_VERSION
                .to_string(),
        semantic_scope: ZKAI_ATTENTION_KV_NATIVE_D32_TWO_HEAD_BOUNDED_SOFTMAX_TABLE_SEMANTIC_SCOPE
            .to_string(),
        decision: ZKAI_ATTENTION_KV_NATIVE_D32_TWO_HEAD_BOUNDED_SOFTMAX_TABLE_DECISION.to_string(),
        input: input.clone(),
        proof: prove_rows(input)?,
    })
}

pub fn zkai_attention_kv_native_d32_two_head_bounded_softmax_table_envelope_from_json_slice(
    raw_json: &[u8],
) -> Result<ZkAiAttentionKvNativeD32TwoHeadBoundedSoftmaxTableEnvelope> {
    if raw_json.len()
    ...
    let envelope: ZkAiAttentionKvNativeD32TwoHeadBoundedSoftmaxTableEnvelope =
...
pub fn verify_zkai_attention_kv_native_d32_two_head_bounded_softmax_table_envelope(
    envelope: &ZkAiAttentionKvNativeD32TwoHeadBoundedSoftmaxTableEnvelope,
) -> Result<bool> {
    validate_envelope(envelope)?;
...
fn validate_envelope(
    ...
    expect_eq(
        ...
        ZKAI_ATTENTION_KV_NATIVE_D32_TWO_HEAD_BOUNDED_SOFTMAX_TABLE_SEMANTIC_SCOPE,
        "semantic scope",
    )?;
    expect_eq(
        &envelope.decision,
        ZKAI_ATTENTION_KV_NATIVE_D32_TWO_HEAD_BOUNDED_SOFTMAX_TABLE_DECISION,
        "decision",
    )?;
    ...
    if envelope.proof.len()
        > ZKAI_ATTENTION_KV_NATIVE_D32_TWO_HEAD_BOUNDED_SOFTMAX_TABLE_MAX_PROOF_BYTES
    {
        return Err(weighted_error(format!(
...
fn validate_input(
    ...
    expect_eq(
        &input.schema,
        ZKAI_ATTENTION_KV_NATIVE_D32_TWO_HEAD_BOUNDED_SOFTMAX_TABLE_INPUT_SCHEMA,
        "schema",
    )?;
    expect_eq(
        &input.decision,
        ZKAI_ATTENTION_KV_NATIVE_D32_TWO_HEAD_BOUNDED_SOFTMAX_TABLE_INPUT_DECISION,
        "input decision",
    )?;
    ...
    expect_eq(
        &input.target_id,
        ZKAI_ATTENTION_KV_NATIVE_D32_TWO_HEAD_BOUNDED_SOFTMAX_TABLE_TARGET_ID,
        "target id",
    )?;
    expect_eq(
    ...
    expect_eq(
        &input.proof_version,
        ZKAI_ATTENTION_KV_NATIVE_D32_TWO_HEAD_BOUNDED_SOFTMAX_TABLE_PROOF_VERSION,
        "proof version",
    )?;
    expect_eq(
    ...
    expect_eq(
        ...
        ZKAI_ATTENTION_KV_NATIVE_D32_TWO_HEAD_BOUNDED_SOFTMAX_TABLE_VERIFIER_DOMAIN,
        "verifier domain",
    )?;
...
pub(crate) fn validate_zkai_attention_kv_native_d32_two_head_bounded_softmax_table_input(
    input: &ZkAiAttentionKvNativeD32TwoHeadBoundedSoftmaxTableProofInput,
) -> Result<()> {
    validate_input(input)
}
...
fn validate_sequence(
    ...
    for (global_step_index, step) in input.input_steps.iter().enumerate() {
        ...
        let next_item = AttentionKvD32TwoHeadBoundedSoftmaxTableEntry {
        ...
        let scored: Vec<(AttentionKvD32TwoHeadBoundedSoftmaxTableEntry, i64)> = next_cache
            .iter()
            .filter(|candidate| {
            ...
            scored.iter().zip(weights.iter()).enumerate()
        {
            ...
            expected_rows.push(AttentionKvD32TwoHeadBoundedSoftmaxTableScoreRow {
...
fn validate_per_head_strict_positions(
    entries: &[AttentionKvD32TwoHeadBoundedSoftmaxTableEntry],
    label: &str,
) -> Result<()> {
...
fn validate_final_kv_append_order(
    ...
    for step in &input.input_steps {
        expected.push(AttentionKvD32TwoHeadBoundedSoftmaxTableEntry {
            head_index: step.head_index,
            position: step.token_position,
            key: step.new_key.clone(),
            value: step.new_value.clone(),
...
fn validate_kv_entry(entry: &AttentionKvD32TwoHeadBoundedSoftmaxTableEntry) -> Result<()> {
    if entry.head_index >= HEAD_COUNT {
...
fn validate_input_step(step: &AttentionKvD32TwoHeadBoundedSoftmaxTableInputStep) -> Result<()> {
    if step.head_index >= HEAD_COUNT {
        return Err(weighted_error("input step head index out of range"));
    }
...
fn validate_score_row(
    row: &AttentionKvD32TwoHeadBoundedSoftmaxTableScoreRow,
...
fn prove_rows(
    ...
    serde_json::to_vec(&AttentionKvNativeD32TwoHeadBoundedSoftmaxTableProofPayload { stark_proof })
        .map_err(|error| VmError::Serialization(error.to_string()))
}
...
fn attention_component() -> FrameworkComponent<AttentionKvNativeD32TwoHeadBoundedSoftmaxTableEval> {
    FrameworkComponent::new(
        ...
        AttentionKvNativeD32TwoHeadBoundedSoftmaxTableEval,
        SecureField::zero(),
    )
}
...
fn padding_row(row_index: usize) -> AttentionKvD32TwoHeadBoundedSoftmaxTableScoreRow {
    AttentionKvD32TwoHeadBoundedSoftmaxTableScoreRow {
        row_index,
        head_index: 0,
        step_index: 0,
        candidate_index: 0,
...
fn column_ids() -> Vec<String> {
    ...
    .into_iter()
    .map(|suffix| format!("zkai/attention-kv/native-d32-two-head-bounded-softmax-table/{suffix}"))
    .collect::<Vec<_>>();
    for prefix in [
        "query",
        "key",
        ...
        for index in 0..width {
            ids.push(format!(
                "zkai/attention-kv/native-d32-two-head-bounded-softmax-table/{prefix}-{index:02}"
            ));
        }
    }
    for index in 0..SCORE_GAP_BITS {
        ids.push(format!(
            "zkai/attention-kv/native-d32-two-head-bounded-softmax-table/score-gap-bit-{index:02}"
        ));
    }
    for index in 0..CAUSAL_GAP_BITS {
        ids.push(format!(
            "zkai/attention-kv/native-d32-two-head-bounded-softmax-table/causal-gap-bit-{index:02}"
        ));
    }
    for index in 0..WEIGHT_BITS {
        ids.push(format!(
            "zkai/attention-kv/native-d32-two-head-bounded-softmax-table/weight-bit-{index:02}"
        ));
    }
    for dim in 0..VALUE_WIDTH {
        for index in 0..OUTPUT_REMAINDER_BITS {
            ids.push(format!(
                "zkai/attention-kv/native-d32-two-head-bounded-softmax-table/output-remainder-{dim:02}-bit-{index:02}"
            ));
        }
    }
    ids
...
fn expected_weight_table_entries() -> Vec<AttentionKvD32TwoHeadBoundedSoftmaxTableWeightEntry> {
    WEIGHT_TABLE
        .iter()
        .map(
            |(gap, weight)| AttentionKvD32TwoHeadBoundedSoftmaxTableWeightEntry {
                gap: *gap,
                weight: *weight,
            },
        )
...
fn validate_weight_table(
    table: &[AttentionKvD32TwoHeadBoundedSoftmaxTableWeightEntry],
) -> Result<()> {
...
fn kv_commitment(
    cache: &[AttentionKvD32TwoHeadBoundedSoftmaxTableEntry],
    domain: &str,
) -> Result<String> {
    let material = cache
        .iter()
...
fn input_steps_commitment(
    steps: &[AttentionKvD32TwoHeadBoundedSoftmaxTableInputStep],
) -> Result<String> {
    let material = steps
        .iter()
        .map(|step| {
...
fn rows_commitment(rows: &[AttentionKvD32TwoHeadBoundedSoftmaxTableScoreRow]) -> Result<String> {
    ...
    commitment_from_parts(
        &[
            (
                "encoding",
                json_string(
                    "attention_kv_stwo_native_d32_two_head_bounded_softmax_table_score_rows_v1",
                )?,
            ),
            (
                "shape",
...
fn score_row_material(row: &AttentionKvD32TwoHeadBoundedSoftmaxTableScoreRow) -> Vec<i64> {
    let mut out = vec![
...
mod tests {
    ...
    fn input() -> ZkAiAttentionKvNativeD32TwoHeadBoundedSoftmaxTableProofInput {
        zkai_attention_kv_native_d32_two_head_bounded_softmax_table_input_from_json_str(INPUT_JSON)
            .expect("d32-two-head bounded Softmax-table attention input")
    }

    #[test]
    fn attention_kv_native_d32_two_head_bounded_softmax_table_input_validates_checked_rows() {
        let input = input();
    ...
    #[test]
    fn attention_kv_native_d32_two_head_bounded_softmax_table_uses_floor_division_for_negative_numerators(
    ) {
        assert_eq!(
    ...
    #[test]
    fn attention_kv_native_d32_two_head_bounded_softmax_table_air_proof_round_trips() {
        let input = input();
        let envelope =
    ...
    #[test]
    fn attention_kv_native_d32_two_head_bounded_softmax_table_rejects_weight_relabeling() {
    ...
    #[test]
    fn attention_kv_native_d32_two_head_bounded_softmax_table_rejects_head_relabeling() {
        let mut value: Value = serde_json::from_str(INPUT_JSON).expect("json");
    ...
    #[test]
    fn attention_kv_native_d32_two_head_bounded_softmax_table_rejects_output_relabeling() {
        let mut value: Value = serde_json::from_str(INPUT_JSON).expect("json");
    ...
    #[test]
    fn attention_kv_native_d32_two_head_bounded_softmax_table_rejects_quotient_remainder_drift() {
        let mut value: Value = serde_json::from_str(INPUT_JSON).expect("json");
    ...
    #[test]
    fn attention_kv_native_d32_two_head_bounded_softmax_table_rejects_initial_kv_position_reorder()
    {
        let mut input = input();
    ...
    #[test]
    fn attention_kv_native_d32_two_head_bounded_softmax_table_rejects_final_kv_append_reorder() {
        let mut input = input();
    ...
    #[test]
    fn attention_kv_native_d32_two_head_bounded_softmax_table_rejects_commitment_drift() {
        let mut value: Value = serde_json::from_str(INPUT_JSON).expect("json");
    ...
    #[test]
    fn attention_kv_native_d32_two_head_bounded_softmax_table_rejects_proof_byte_tamper() {
        let input = input();
        let mut envelope =
            prove_zkai_attention_kv_native_d32_two_head_bounded_softmax_table_envelope(&input)
                .expect("d32-two-head bounded Softmax-table attention proof");
    ...
    #[test]
    fn attention_kv_native_d32_two_head_bounded_softmax_table_rejects_unknown_envelope_field() {
        let input = input();
        let envelope =
            prove_zkai_attention_kv_native_d32_two_head_bounded_softmax_table_envelope(&input)
                .expect("d32-two-head bounded Softmax-table attention proof");

...
pub const ZKAI_ATTENTION_KV_NATIVE_D64_SINGLE_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_INPUT_SCHEMA: &str =
    "zkai-attention-kv-stwo-native-d64-single-head-longseq-bounded-softmax-table-air-proof-input-v1";
pub const ZKAI_ATTENTION_KV_NATIVE_D64_SINGLE_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_INPUT_DECISION:
    &str =
    "GO_INPUT_FOR_STWO_NATIVE_ATTENTION_KV_D64_SINGLE_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_AIR_PROOF";
pub const ZKAI_ATTENTION_KV_NATIVE_D64_SINGLE_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_PROOF_VERSION:
    &str =
    "stwo-attention-kv-d64-single-head-longseq-causal-mask-bounded-softmax-table-air-proof-v1";
pub const ZKAI_ATTENTION_KV_NATIVE_D64_SINGLE_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_STATEMENT_VERSION: &str =
    "zkai-attention-kv-stwo-native-d64-single-head-longseq-bounded-softmax-table-statement-v1";
pub const ZKAI_ATTENTION_KV_NATIVE_D64_SINGLE_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_SEMANTIC_SCOPE: &str =
    "d64_single_head_longseq_bounded_table_softmax_approx_attention_kv_causal_mask_rows_bound_to_statement_receipt";
pub const ZKAI_ATTENTION_KV_NATIVE_D64_SINGLE_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_DECISION: &str =
    "GO_STWO_NATIVE_ATTENTION_KV_BOUNDED_SOFTMAX_TABLE_AIR_PROOF";
pub const ZKAI_ATTENTION_KV_NATIVE_D64_SINGLE_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_TARGET_ID: &str =
    "attention-kv-d64-single-head-longseq-causal-mask-bounded-softmax-table-v1";
pub const ZKAI_ATTENTION_KV_NATIVE_D64_SINGLE_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_REQUIRED_BACKEND_VERSION: &str =
    "stwo-attention-kv-d64-single-head-longseq-causal-mask-bounded-softmax-table-v1";
pub const ZKAI_ATTENTION_KV_NATIVE_D64_SINGLE_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_VERIFIER_DOMAIN:
    &str = "ptvm:zkai:attention-kv-stwo-native-d64-single-head-longseq-bounded-softmax-table:v1";
...
pub const ZKAI_ATTENTION_KV_NATIVE_D64_SINGLE_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_MAX_INPUT_JSON_BYTES: usize =
    8_388_608;
pub const ZKAI_ATTENTION_KV_NATIVE_D64_SINGLE_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_MAX_ENVELOPE_JSON_BYTES: usize =
    16_777_216;
...
pub const ZKAI_ATTENTION_KV_NATIVE_D64_SINGLE_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_MAX_PROOF_BYTES:
    usize = 524_288;

const ROW_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d64-single-head-longseq-bounded-softmax-table-score-rows:v1";
const INITIAL_KV_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d64-single-head-longseq-bounded-softmax-table-initial-kv:v1";
const INPUT_STEPS_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d64-single-head-longseq-bounded-softmax-table-input-steps:v1";
const FINAL_KV_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d64-single-head-longseq-bounded-softmax-table-final-kv:v1";
const OUTPUTS_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d64-single-head-longseq-bounded-softmax-table-outputs:v1";
const PUBLIC_INSTANCE_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d64-single-head-longseq-bounded-softmax-table-public-instance:v1";
const PROOF_NATIVE_PARAMETER_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d64-single-head-longseq-bounded-softmax-table-proof-parameters:v1";
const WEIGHT_TABLE_DOMAIN: &str =
    "ptvm:zkai:attention-kv-stwo-native-d64-single-head-longseq-bounded-softmax-table-weight-table:v1";
...
const NEXT_BACKEND_STEP: &str = "fuse this d64 single-head seq16 bounded Softmax-table source with AIR-private LogUp table membership, then compare against a matched d64 single-head seq16 source-plus-sidecar route";
...
#[derive(Debug, Clone)]
struct AttentionKvNativeD64SingleHeadLongseqBoundedSoftmaxTableEval;

impl FrameworkEval for AttentionKvNativeD64SingleHeadLongseqBoundedSoftmaxTableEval {
...
pub struct AttentionKvD64SingleHeadLongseqBoundedSoftmaxTableEntry {
    pub position: usize,
    pub key: Vec<i64>,
    pub value: Vec<i64>,
}
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct AttentionKvD64SingleHeadLongseqBoundedSoftmaxTableInputStep {
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct AttentionKvD64SingleHeadLongseqBoundedSoftmaxTableWeightEntry {
    pub gap: usize,
    pub weight: i64,
}
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct AttentionKvD64SingleHeadLongseqBoundedSoftmaxTableScoreRow {
    pub row_index: usize,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct ZkAiAttentionKvNativeD64SingleHeadLongseqBoundedSoftmaxTableProofInput {
    pub schema: String,
    pub decision: String,
    pub issue: usize,
    ...
    pub weight_table: Vec<AttentionKvD64SingleHeadLongseqBoundedSoftmaxTableWeightEntry>,
    ...
    pub initial_kv_cache: Vec<AttentionKvD64SingleHeadLongseqBoundedSoftmaxTableEntry>,
    pub input_steps: Vec<AttentionKvD64SingleHeadLongseqBoundedSoftmaxTableInputStep>,
    pub final_kv_cache: Vec<AttentionKvD64SingleHeadLongseqBoundedSoftmaxTableEntry>,
    pub attention_outputs: Vec<Vec<i64>>,
    pub score_rows: Vec<AttentionKvD64SingleHeadLongseqBoundedSoftmaxTableScoreRow>,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct ZkAiAttentionKvNativeD64SingleHeadLongseqBoundedSoftmaxTableEnvelope {
    pub proof_backend: StarkProofBackend,
    pub proof_backend_version: String,
    pub statement_version: String,
    pub semantic_scope: String,
    pub decision: String,
    pub input: ZkAiAttentionKvNativeD64SingleHeadLongseqBoundedSoftmaxTableProofInput,
    pub proof: Vec<u8>,
}

#[derive(Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
struct AttentionKvNativeD64SingleHeadLongseqBoundedSoftmaxTableProofPayload {
    stark_proof: StarkProof<Blake2sM31MerkleHasher>,
}

pub fn zkai_attention_kv_native_d64_single_head_longseq_bounded_softmax_table_input_from_json_str(
    raw_json: &str,
) -> Result<ZkAiAttentionKvNativeD64SingleHeadLongseqBoundedSoftmaxTableProofInput> {
    if raw_json.len() > ZKAI_ATTENTION_KV_NATIVE_D64_SINGLE_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_MAX_INPUT_JSON_BYTES {
    ...
    let input: ZkAiAttentionKvNativeD64SingleHeadLongseqBoundedSoftmaxTableProofInput =
...
pub fn prove_zkai_attention_kv_native_d64_single_head_longseq_bounded_softmax_table_envelope(
    input: &ZkAiAttentionKvNativeD64SingleHeadLongseqBoundedSoftmaxTableProofInput,
) -> Result<ZkAiAttentionKvNativeD64SingleHeadLongseqBoundedSoftmaxTableEnvelope> {
    validate_input(input)?;
    Ok(ZkAiAttentionKvNativeD64SingleHeadLongseqBoundedSoftmaxTableEnvelope {
        proof_backend: StarkProofBackend::Stwo,
        proof_backend_version:
            ZKAI_ATTENTION_KV_NATIVE_D64_SINGLE_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_REQUIRED_BACKEND_VERSION.to_string(),
        statement_version: ZKAI_ATTENTION_KV_NATIVE_D64_SINGLE_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_STATEMENT_VERSION
            .to_string(),
        semantic_scope: ZKAI_ATTENTION_KV_NATIVE_D64_SINGLE_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_SEMANTIC_SCOPE
            .to_string(),
        decision: ZKAI_ATTENTION_KV_NATIVE_D64_SINGLE_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_DECISION.to_string(),
        input: input.clone(),
        proof: prove_rows(input)?,
    })
}

pub fn zkai_attention_kv_native_d64_single_head_longseq_bounded_softmax_table_envelope_from_json_slice(
    raw_json: &[u8],
) -> Result<ZkAiAttentionKvNativeD64SingleHeadLongseqBoundedSoftmaxTableEnvelope> {
    if raw_json.len() > ZKAI_ATTENTION_KV_NATIVE_D64_SINGLE_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_MAX_ENVELOPE_JSON_BYTES {
        return Err(weighted_error(format!(
    ...
    let envelope: ZkAiAttentionKvNativeD64SingleHeadLongseqBoundedSoftmaxTableEnvelope =
...
pub fn verify_zkai_attention_kv_native_d64_single_head_longseq_bounded_softmax_table_envelope(
    envelope: &ZkAiAttentionKvNativeD64SingleHeadLongseqBoundedSoftmaxTableEnvelope,
) -> Result<bool> {
    validate_envelope(envelope)?;
...
fn validate_envelope(
    ...
    expect_eq(
        ...
        ZKAI_ATTENTION_KV_NATIVE_D64_SINGLE_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_REQUIRED_BACKEND_VERSION,
        "proof backend version",
    )?;
    expect_eq(
        &envelope.statement_version,
        ZKAI_ATTENTION_KV_NATIVE_D64_SINGLE_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_STATEMENT_VERSION,
        "statement version",
    )?;
    expect_eq(
        &envelope.semantic_scope,
        ZKAI_ATTENTION_KV_NATIVE_D64_SINGLE_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_SEMANTIC_SCOPE,
        "semantic scope",
    )?;
    expect_eq(
        &envelope.decision,
        ZKAI_ATTENTION_KV_NATIVE_D64_SINGLE_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_DECISION,
        "decision",
    )?;
    ...
    if envelope.proof.len()
        > ZKAI_ATTENTION_KV_NATIVE_D64_SINGLE_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_MAX_PROOF_BYTES
    {
        return Err(weighted_error(format!(
...
fn validate_input(
    ...
    expect_eq(
        &input.schema,
        ZKAI_ATTENTION_KV_NATIVE_D64_SINGLE_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_INPUT_SCHEMA,
        "schema",
    )?;
    expect_eq(
        &input.decision,
        ZKAI_ATTENTION_KV_NATIVE_D64_SINGLE_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_INPUT_DECISION,
        "input decision",
    )?;
    ...
    expect_eq(
        &input.target_id,
        ZKAI_ATTENTION_KV_NATIVE_D64_SINGLE_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_TARGET_ID,
        "target id",
    )?;
    expect_eq(
    ...
    expect_eq(
        &input.proof_version,
        ZKAI_ATTENTION_KV_NATIVE_D64_SINGLE_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_PROOF_VERSION,
        "proof version",
    )?;
    expect_eq(
    ...
    expect_eq(
        ...
        ZKAI_ATTENTION_KV_NATIVE_D64_SINGLE_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_VERIFIER_DOMAIN,
        "verifier domain",
    )?;
...
pub(crate) fn validate_zkai_attention_kv_native_d64_single_head_longseq_bounded_softmax_table_input(
    input: &ZkAiAttentionKvNativeD64SingleHeadLongseqBoundedSoftmaxTableProofInput,
) -> Result<()> {
    validate_input(input)
}
...
fn validate_sequence(
    ...
    for (step_index, step) in input.input_steps.iter().enumerate() {
        ...
        let next_item = AttentionKvD64SingleHeadLongseqBoundedSoftmaxTableEntry {
        ...
        let scored: Vec<(AttentionKvD64SingleHeadLongseqBoundedSoftmaxTableEntry, i64)> =
            next_cache
                .iter()
            ...
            scored.iter().zip(weights.iter()).enumerate()
        {
            ...
            expected_rows.push(AttentionKvD64SingleHeadLongseqBoundedSoftmaxTableScoreRow {
...
fn validate_kv_entry(
    entry: &AttentionKvD64SingleHeadLongseqBoundedSoftmaxTableEntry,
) -> Result<()> {
...
fn validate_input_step(
    step: &AttentionKvD64SingleHeadLongseqBoundedSoftmaxTableInputStep,
    step_index: usize,
) -> Result<()> {
    expect_usize(
        step.token_position,
...
fn validate_score_row(
    row: &AttentionKvD64SingleHeadLongseqBoundedSoftmaxTableScoreRow,
        ...
        prove::<SimdBackend, Blake2sM31MerkleChannel>(&[&component], channel, commitment_scheme)
            .map_err(|error| {
                VmError::UnsupportedProof(format!(
                    "attention/KV native d64 single-head seq16 bounded Softmax-table AIR proving failed: {error}"
                ))
            })?;
    serde_json::to_vec(
        &AttentionKvNativeD64SingleHeadLongseqBoundedSoftmaxTableProofPayload { stark_proof },
    )
    .map_err(|error| VmError::Serialization(error.to_string()))
}
...
fn verify_rows(
    ...
    validate_input(input)?;
    let payload: AttentionKvNativeD64SingleHeadLongseqBoundedSoftmaxTableProofPayload =
    ...
    verify(&[&component], channel, commitment_scheme, stark_proof)
        ...
        .map_err(|error| {
            weighted_error(format!(
                "attention/KV native d64 single-head seq16 bounded Softmax-table proof rejected: {error}"
            ))
        })
}
...
) -> FrameworkComponent<AttentionKvNativeD64SingleHeadLongseqBoundedSoftmaxTableEval> {
    FrameworkComponent::new(
        &mut TraceLocationAllocator::new_with_preprocessed_columns(&preprocessed_column_ids()),
        AttentionKvNativeD64SingleHeadLongseqBoundedSoftmaxTableEval,
        SecureField::zero(),
    )
}
...
fn padding_row(row_index: usize) -> AttentionKvD64SingleHeadLongseqBoundedSoftmaxTableScoreRow {
    AttentionKvD64SingleHeadLongseqBoundedSoftmaxTableScoreRow {
        row_index,
        step_index: 0,
        candidate_index: 0,
        token_position: 0,
...
fn column_ids() -> Vec<String> {
    ...
    .into_iter()
    .map(|suffix| {
        format!("zkai/attention-kv/native-d64-single-head-longseq-bounded-softmax-table/{suffix}")
    })
    .collect::<Vec<_>>();
    for prefix in [
        "query",
        ...
        for index in 0..width {
            ids.push(format!(
                "zkai/attention-kv/native-d64-single-head-longseq-bounded-softmax-table/{prefix}-{index:02}"
            ));
        }
    }
    for index in 0..SCORE_GAP_BITS {
        ids.push(format!(
            "zkai/attention-kv/native-d64-single-head-longseq-bounded-softmax-table/score-gap-bit-{index:02}"
        ));
    }
    for index in 0..CAUSAL_GAP_BITS {
        ids.push(format!(
            "zkai/attention-kv/native-d64-single-head-longseq-bounded-softmax-table/causal-gap-bit-{index:02}"
        ));
    }
    for index in 0..WEIGHT_BITS {
        ids.push(format!(
            "zkai/attention-kv/native-d64-single-head-longseq-bounded-softmax-table/weight-bit-{index:02}"
        ));
    }
    for dim in 0..VALUE_WIDTH {
        for index in 0..OUTPUT_REMAINDER_BITS {
            ids.push(format!(
                "zkai/attention-kv/native-d64-single-head-longseq-bounded-softmax-table/output-remainder-{dim:02}-bit-{index:02}"
            ));
        }
    }
    ids
...
) -> Vec<AttentionKvD64SingleHeadLongseqBoundedSoftmaxTableWeightEntry> {
    WEIGHT_TABLE
        .iter()
        .map(
            |(gap, weight)| AttentionKvD64SingleHeadLongseqBoundedSoftmaxTableWeightEntry {
                gap: *gap,
                weight: *weight,
            },
        )
...
fn validate_weight_table(
    table: &[AttentionKvD64SingleHeadLongseqBoundedSoftmaxTableWeightEntry],
) -> Result<()> {
...
fn kv_commitment(
    cache: &[AttentionKvD64SingleHeadLongseqBoundedSoftmaxTableEntry],
    domain: &str,
) -> Result<String> {
    let material = cache
        .iter()
...
fn input_steps_commitment(
    steps: &[AttentionKvD64SingleHeadLongseqBoundedSoftmaxTableInputStep],
) -> Result<String> {
    let material = steps
        .iter()
        .map(|step| {
...
fn rows_commitment(
    rows: &[AttentionKvD64SingleHeadLongseqBoundedSoftmaxTableScoreRow],
) -> Result<String> {
...
fn weighted_error(message: impl Into<String>) -> VmError {
    VmError::InvalidConfig(format!(
        "attention/KV native d64 single-head seq16 bounded Softmax-table proof: {}",
        message.into()
    ))
}
...
mod tests {
    ...
    const INPUT_JSON: &str = include_str!(
        "../../docs/engineering/evidence/zkai-attention-kv-stwo-native-d64-single-head-longseq-bounded-softmax-table-proof-2026-05.json"
    );

    fn input() -> ZkAiAttentionKvNativeD64SingleHeadLongseqBoundedSoftmaxTableProofInput {
        zkai_attention_kv_native_d64_single_head_longseq_bounded_softmax_table_input_from_json_str(
            INPUT_JSON,
        )
        .expect("d64 single-head seq16 bounded Softmax-table attention input")
    }

    #[test]
    fn attention_kv_native_d64_single_head_longseq_bounded_softmax_table_input_validates_checked_rows(
    ) {
        let input = input();
        ...
        assert_eq!(score_row_material_width(), 524);
        assert_eq!(
    ...
    #[test]
    fn attention_kv_native_d64_single_head_longseq_bounded_softmax_table_uses_floor_division_for_negative_numerators(
    ) {
        assert_eq!(
    ...
    #[test]
    fn attention_kv_native_d64_single_head_longseq_bounded_softmax_table_air_proof_round_trips() {
        let input = input();
        let envelope =
            prove_zkai_attention_kv_native_d64_single_head_longseq_bounded_softmax_table_envelope(
                &input,
            )
            .expect("d64 single-head seq16 bounded Softmax-table attention proof");
    ...
    #[test]
    fn attention_kv_native_d64_single_head_longseq_bounded_softmax_table_rejects_weight_relabeling()
    {
        let mut value: Value = serde_json::from_str(INPUT_JSON).expect("json");
        value["score_rows"][0]["attention_weight"] = Value::from(15);
        let error = zkai_attention_kv_native_d64_single_head_longseq_bounded_softmax_table_input_from_json_str(
    ...
    #[test]
    fn attention_kv_native_d64_single_head_longseq_bounded_softmax_table_rejects_table_relabeling()
    {
        let mut value: Value = serde_json::from_str(INPUT_JSON).expect("json");
    ...
    #[test]
    fn attention_kv_native_d64_single_head_longseq_bounded_softmax_table_rejects_output_relabeling()
    {
        let mut value: Value = serde_json::from_str(INPUT_JSON).expect("json");
    ...
    #[test]
    fn attention_kv_native_d64_single_head_longseq_bounded_softmax_table_rejects_quotient_remainder_drift(
    ) {
        let mut value: Value = serde_json::from_str(INPUT_JSON).expect("json");
    ...
    #[test]
    fn attention_kv_native_d64_single_head_longseq_bounded_softmax_table_rejects_commitment_drift()
    {
        let mut value: Value = serde_json::from_str(INPUT_JSON).expect("json");
    ...
    #[test]
    fn attention_kv_native_d64_single_head_longseq_bounded_softmax_table_rejects_proof_byte_tamper()
    {
        let input = input();
        let mut envelope =
            prove_zkai_attention_kv_native_d64_single_head_longseq_bounded_softmax_table_envelope(
    ...
    #[test]
    fn attention_kv_native_d64_single_head_longseq_bounded_softmax_table_rejects_unknown_envelope_field(
    ) {
        let input = input();
        let envelope =
            prove_zkai_attention_kv_native_d64_single_head_longseq_bounded_softmax_table_envelope(
        ...
        let error =
            zkai_attention_kv_native_d64_single_head_longseq_bounded_softmax_table_envelope_from_json_slice(&raw)
                .unwrap_err();

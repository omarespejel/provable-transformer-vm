...
pub const ZKAI_ATTENTION_KV_NATIVE_D32_FOUR_HEAD_LONGSEQ_SOFTMAX_TABLE_LOOKUP_PROOF_VERSION: &str =
    "stwo-attention-kv-d32-four-head-longseq-softmax-table-logup-sidecar-proof-v1";
pub const ZKAI_ATTENTION_KV_NATIVE_D32_FOUR_HEAD_LONGSEQ_SOFTMAX_TABLE_LOOKUP_STATEMENT_VERSION:
    &str =
    "zkai-attention-kv-stwo-native-d32-four-head-longseq-softmax-table-logup-sidecar-statement-v1";
pub const ZKAI_ATTENTION_KV_NATIVE_D32_FOUR_HEAD_LONGSEQ_SOFTMAX_TABLE_LOOKUP_SEMANTIC_SCOPE: &str =
    "d32_four_head_longseq_bounded_softmax_table_membership_constrained_by_native_stwo_logup_sidecar";
pub const ZKAI_ATTENTION_KV_NATIVE_D32_FOUR_HEAD_LONGSEQ_SOFTMAX_TABLE_LOOKUP_DECISION: &str =
    "GO_NATIVE_STWO_AIR_CONSTRAINED_SOFTMAX_TABLE_LOOKUP_RELATION_SIDECAR";
pub const ZKAI_ATTENTION_KV_NATIVE_D32_FOUR_HEAD_LONGSEQ_SOFTMAX_TABLE_LOOKUP_TARGET_ID: &str =
    "attention-kv-d32-four-head-longseq-causal-mask-bounded-softmax-table-logup-sidecar-v1";
pub const ZKAI_ATTENTION_KV_NATIVE_D32_FOUR_HEAD_LONGSEQ_SOFTMAX_TABLE_LOOKUP_VERIFIER_DOMAIN:
    &str =
    "ptvm:zkai:attention-kv-stwo-native-d32-four-head-longseq-softmax-table-logup-sidecar:v1";
pub const ZKAI_ATTENTION_KV_NATIVE_D32_FOUR_HEAD_LONGSEQ_SOFTMAX_TABLE_LOOKUP_MAX_ENVELOPE_JSON_BYTES:
    usize = 8_388_608;
pub const ZKAI_ATTENTION_KV_NATIVE_D32_FOUR_HEAD_LONGSEQ_SOFTMAX_TABLE_LOOKUP_MAX_PROOF_BYTES:
    usize = 262_144;
...
const PREPROCESSED_TABLE_GAP: &str =
    "zkai/attention-kv/native-d32-four-head-longseq-softmax-table-logup/table-gap";
...
#[derive(Debug, Clone)]
struct AttentionKvD32FourHeadLongseqSoftmaxTableLookupEval {
    lookup_elements: AttentionKvD32FourHeadLongseqSoftmaxTableLookupRelation,
}

impl FrameworkEval for AttentionKvD32FourHeadLongseqSoftmaxTableLookupEval {
...
pub struct AttentionKvD32FourHeadLongseqSoftmaxTableLookupMultiplicity {
    pub gap: usize,
    pub weight: i64,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct ZkAiAttentionKvNativeD32FourHeadLongseqSoftmaxTableLookupSummary {
    ...
    pub table_multiplicities: Vec<AttentionKvD32FourHeadLongseqSoftmaxTableLookupMultiplicity>,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct ZkAiAttentionKvNativeD32FourHeadLongseqSoftmaxTableLookupEnvelope {
    ...
    pub lookup_summary: ZkAiAttentionKvNativeD32FourHeadLongseqSoftmaxTableLookupSummary,
...
#[serde(deny_unknown_fields)]
struct AttentionKvD32FourHeadLongseqSoftmaxTableLookupProofPayload {
...
pub fn prove_zkai_attention_kv_native_d32_four_head_longseq_softmax_table_lookup_envelope(
    source_input: &ZkAiAttentionKvNativeD32FourHeadLongseqBoundedSoftmaxTableProofInput,
) -> Result<ZkAiAttentionKvNativeD32FourHeadLongseqSoftmaxTableLookupEnvelope> {
    validate_source_input(source_input)?;
    let bundle = build_lookup_bundle(source_input)?;
    let proof = prove_lookup(&bundle)?;
    let envelope = ZkAiAttentionKvNativeD32FourHeadLongseqSoftmaxTableLookupEnvelope {
        proof_backend: StarkProofBackend::Stwo,
        proof_backend_version:
            ZKAI_ATTENTION_KV_NATIVE_D32_FOUR_HEAD_LONGSEQ_SOFTMAX_TABLE_LOOKUP_PROOF_VERSION
                .to_string(),
        statement_version:
            ZKAI_ATTENTION_KV_NATIVE_D32_FOUR_HEAD_LONGSEQ_SOFTMAX_TABLE_LOOKUP_STATEMENT_VERSION
                .to_string(),
        semantic_scope:
            ZKAI_ATTENTION_KV_NATIVE_D32_FOUR_HEAD_LONGSEQ_SOFTMAX_TABLE_LOOKUP_SEMANTIC_SCOPE
                .to_string(),
        decision: ZKAI_ATTENTION_KV_NATIVE_D32_FOUR_HEAD_LONGSEQ_SOFTMAX_TABLE_LOOKUP_DECISION
            .to_string(),
        verifier_domain:
            ZKAI_ATTENTION_KV_NATIVE_D32_FOUR_HEAD_LONGSEQ_SOFTMAX_TABLE_LOOKUP_VERIFIER_DOMAIN
                .to_string(),
...
pub fn zkai_attention_kv_native_d32_four_head_longseq_softmax_table_lookup_envelope_from_json_slice(
    raw_json: &[u8],
) -> Result<ZkAiAttentionKvNativeD32FourHeadLongseqSoftmaxTableLookupEnvelope> {
    if raw_json.len()
...
pub fn verify_zkai_attention_kv_native_d32_four_head_longseq_softmax_table_lookup_envelope(
    envelope: &ZkAiAttentionKvNativeD32FourHeadLongseqSoftmaxTableLookupEnvelope,
) -> Result<bool> {
    validate_envelope(envelope)?;
...
fn validate_envelope(
    ...
    expect_eq(
        &envelope.decision,
        ZKAI_ATTENTION_KV_NATIVE_D32_FOUR_HEAD_LONGSEQ_SOFTMAX_TABLE_LOOKUP_DECISION,
        "lookup decision",
    )?;
    expect_eq(
    ...
    if envelope.proof.is_empty()
        || envelope.proof.len()
            > ZKAI_ATTENTION_KV_NATIVE_D32_FOUR_HEAD_LONGSEQ_SOFTMAX_TABLE_LOOKUP_MAX_PROOF_BYTES
    {
...
fn validate_source_input(
    ...
    zkai_attention_kv_native_d32_four_head_longseq_bounded_softmax_table_input_from_json_str(&raw)?;
    Ok(())
}

fn lookup_summary(
    input: &ZkAiAttentionKvNativeD32FourHeadLongseqBoundedSoftmaxTableProofInput,
) -> Result<ZkAiAttentionKvNativeD32FourHeadLongseqSoftmaxTableLookupSummary> {
    let mut multiplicities = input
        .weight_table
        .iter()
        .map(
            |entry| AttentionKvD32FourHeadLongseqSoftmaxTableLookupMultiplicity {
                gap: entry.gap,
                weight: entry.weight,
                multiplicity: 0,
            },
    ...
    Ok(
        ZkAiAttentionKvNativeD32FourHeadLongseqSoftmaxTableLookupSummary {
            ...
            lookup_relation: "AttentionKvD32FourHeadLongseqSoftmaxTableLookupRelation".to_string(),
...
fn prove_lookup(bundle: &LookupBundle) -> Result<Vec<u8>> {
    let component =
        lookup_component(AttentionKvD32FourHeadLongseqSoftmaxTableLookupRelation::dummy());
    ...
    let lookup_elements = AttentionKvD32FourHeadLongseqSoftmaxTableLookupRelation::draw(channel);
    ...
    serde_json::to_vec(&AttentionKvD32FourHeadLongseqSoftmaxTableLookupProofPayload { stark_proof })
        .map_err(|error| VmError::Serialization(error.to_string()))
}
...
fn verify_lookup(
    ...
    let payload: AttentionKvD32FourHeadLongseqSoftmaxTableLookupProofPayload =
...
mod tests {
    ...
    fn source_input() -> ZkAiAttentionKvNativeD32FourHeadLongseqBoundedSoftmaxTableProofInput {
        ...
        zkai_attention_kv_native_d32_four_head_longseq_softmax_table_lookup_source_input_from_json_str(raw)
            .expect("source input")
    }

    #[test]
    fn attention_kv_d32_four_head_longseq_softmax_table_lookup_sidecar_round_trips_real_proof() {
    ...
    #[test]
    fn attention_kv_d32_four_head_longseq_softmax_table_lookup_summary_counts_claims() {
        let input = source_input();
    ...
    #[test]
    fn attention_kv_d32_four_head_longseq_softmax_table_lookup_rejects_empty_table_without_panic() {
    ...
    #[test]
    fn attention_kv_d32_four_head_longseq_softmax_table_lookup_rejects_preprocessed_overflow_without_panic(
    ) {
        let input = source_input();
        let mut summary = lookup_summary(&input).expect("summary");
    ...
    #[test]
    fn attention_kv_d32_four_head_longseq_softmax_table_lookup_masks_inactive_denominators() {
        let guarded =
    ...
    #[test]
    fn attention_kv_d32_four_head_longseq_softmax_table_lookup_preserves_one_sided_contributions() {
    ...
    #[test]
    fn attention_kv_d32_four_head_longseq_softmax_table_lookup_rejects_summary_drift() {
        let input = source_input();
        let mut envelope =
            prove_zkai_attention_kv_native_d32_four_head_longseq_softmax_table_lookup_envelope(
                &input,
    ...
    #[test]
    fn attention_kv_d32_four_head_longseq_softmax_table_lookup_rejects_source_weight_drift() {
        let input = source_input();
        let mut envelope =
            prove_zkai_attention_kv_native_d32_four_head_longseq_softmax_table_lookup_envelope(
                &input,
    ...
    #[test]
    fn attention_kv_d32_four_head_longseq_softmax_table_lookup_rejects_proof_byte_tamper() {
        let input = source_input();
        let mut envelope =
            prove_zkai_attention_kv_native_d32_four_head_longseq_softmax_table_lookup_envelope(
                &input,

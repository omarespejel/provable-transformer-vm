...
bytes. The gate rejects `14 / 14` overclaim mutations covering compact
...
policy, unqualified timing policy, favorable-label promotion, non-claim removal, external native
equivalence, missing proof-size policy, and source digest drift. Treat this as

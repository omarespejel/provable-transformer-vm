...
**Mainline tip at last refresh:** `e575bccfe82097cf35db9bc4f6b19dc8442df1ab` (matches
...
52. `docs/engineering/zkai-attention-kv-stwo-native-d128-four-head-seq64-fused-softmax-table-gate-2026-05-23.md`
53. `docs/engineering/zkai-attention-kv-stwo-native-d64-two-head-seq32-fused-softmax-table-gate-2026-05-21.md`
54. `docs/engineering/zkai-attention-kv-fused-softmax-table-route-matrix-2026-05-09.md`
55. `docs/engineering/zkai-attention-kv-fused-softmax-table-microprofile-2026-05-10.md`
56. `docs/engineering/zkai-attention-kv-fused-softmax-table-section-delta-2026-05-10.md`
57. `docs/engineering/zkai-attention-kv-stwo-fine-grained-component-schema-2026-05-10.md`
58. `docs/engineering/zkai-attention-kv-stwo-controlled-component-grid-2026-05-10.md`
59. `docs/engineering/zkai-attention-kv-proof-route-selector-2026-05-05.md`
60. `docs/engineering/zkai-attention-derived-d128-rmsnorm-public-row-2026-05-13.md`
61. `docs/engineering/zkai-attention-derived-d128-projection-boundary-2026-05-13.md`
62. `docs/engineering/zkai-attention-derived-d128-activation-swiglu-2026-05-13.md`
63. `docs/engineering/zkai-attention-derived-d128-down-projection-2026-05-13.md`
64. `docs/engineering/zkai-attention-derived-d128-residual-add-2026-05-13.md`
65. `docs/engineering/zkai-attention-derived-d128-block-statement-chain-2026-05-13.md`
66. `docs/engineering/zkai-attention-derived-d128-statement-chain-compression-2026-05-13.md`
67. `docs/engineering/zkai-attention-derived-d128-outer-proof-route-2026-05-13.md`
68. `docs/engineering/zkai-attention-derived-d128-snark-statement-receipt-2026-05-14.md`
69. `docs/engineering/zkai-one-block-executable-package-accounting-2026-05-14.md`
70. `docs/engineering/zkai-native-d128-block-proof-object-route-2026-05-14.md`
71. `docs/engineering/zkai-native-d128-compressed-outer-statement-binary-accounting-2026-05-14.md`
72. `docs/engineering/zkai-native-d128-verifier-execution-compression-budget-2026-05-15.md`
73. `docs/engineering/zkai-d128-component-compact-preprocessed-reprove-2026-05-15.md`
74. `docs/engineering/zkai-d128-gate-value-compact-preprocessed-probe-2026-05-15.md`
75. `docs/engineering/zkai-d128-rmsnorm-mlp-fused-proof-2026-05-15.md`
76. `docs/engineering/zkai-d128-attention-rmsnorm-mlp-boundary-2026-05-15.md`
77. `docs/engineering/zkai-d128-value-adapter-policy-frontier-2026-05-15.md`
78. `docs/engineering/zkai-attention-derived-d128-native-mlp-proof-route-2026-05-15.md`
79. `docs/engineering/zkai-attention-derived-d128-mlp-fusion-attribution-2026-05-16.md`
80. `docs/engineering/zkai-d128-attention-mlp-boundary-frontier-2026-05-16.md`
81. `docs/engineering/zkai-native-attention-mlp-single-proof-route-2026-05-16.md`
82. `docs/engineering/zkai-native-attention-mlp-single-proof-object-2026-05-16.md`
83. `docs/engineering/zkai-native-attention-mlp-lifting-ablation-2026-05-16.md`
84. `docs/engineering/zkai-native-attention-mlp-adapter-air-frontier-2026-05-16.md`
85. `docs/engineering/zkai-attention-derived-d128-native-gate-value-projection-2026-05-16.md`
86. `docs/engineering/zkai-attention-derived-d128-native-activation-swiglu-2026-05-16.md`
87. `docs/engineering/zkai-attention-derived-d128-native-down-projection-2026-05-16.md`
88. `docs/engineering/zkai-native-attention-mlp-rmsnorm-input-fused-adapter-2026-05-17.md`
89. `docs/engineering/zkai-native-attention-mlp-adapter-opening-geometry-budget-2026-05-17.md`
90. `docs/engineering/zkai-gkr-dense-sidecar-baseline-2026-05-17.md`
91. `docs/engineering/zkai-jolt-atlas-lookup-tensor-comparison-2026-05-17.md`
92. `docs/engineering/zkai-tablero-hybrid-zkml-boundary-2026-05-17.md`
93. `docs/engineering/zkai-claim-audit-comparison-artifacts-2026-05-17.md`
94. `docs/engineering/zkai-hybrid-proof-pressure-selector-2026-05-17.md`
95. `docs/engineering/zkai-gkr-d128-projection-scaling-preflight-2026-05-17.md`
96. `docs/engineering/zkai-native-attention-mlp-rmsnorm-post-tail-layout-2026-05-18.md`
97. `docs/engineering/zkai-seq32-derived-d128-native-mlp-surface-2026-05-18.md`
98. `docs/engineering/zkai-seq32-value-compatible-boundary-frontier-2026-05-18.md`
99. `docs/engineering/zkai-native-seq32-attention-mlp-predecommit-opening-policy-2026-05-19.md`
100. `docs/engineering/zkai-bounded-stwo-query-policy-hook-2026-05-19.md`
101. `docs/engineering/zkai-stwo-query-preview-split-prototype-2026-05-19.md`
102. `docs/engineering/zkai-stwo-query-grinding-budget-2026-05-19.md`
103. `docs/engineering/zkai-stwo-attempt-domain-binding-2026-05-19.md`
104. `docs/engineering/zkai-stwo-inner-attempt-domain-statement-2026-05-19.md`
...
107. `docs/engineering/zkai-minimal-d128-block-boundary-wrapper-2026-05-24.md`
108. `docs/engineering/zkai-native-d128-seq32-attention-derived-mlp-single-proof-2026-05-24.md`
109. `docs/engineering/zkai-native-d128-seq32-attention-mlp-single-proof-2026-05-24.md`
110. `docs/engineering/reproducibility.md`
...
The STARK-native zkML research program also has a structured agent source of
...
(`0.932282x`) against the matched split frontier. It is `2,622` bytes larger
than the source arithmetic proof alone, so the honest claim is
...
(`0.887604x`) against the matched split frontier. It is `1,744` bytes larger
than the source arithmetic proof alone, so the honest claim is
source-plus-sidecar fusion saving, not source-only compression. Holding d64 and
...
(`0.801661x`) against the matched split frontier. Holding d32 and seq32 fixed
from two heads to four heads, lookup claims grow `2.000000x` and trace rows
grow `2.000000x`, while fused proof bytes grow only `1.030124x`. See
`docs/engineering/zkai-attention-kv-stwo-native-d32-four-head-seq32-fused-softmax-table-gate-2026-05-22.md`.

Earlier proof-pressure route extension: issue `#715` has the
...
Latest attribution follow-up: the exact six-envelope derived d128 MLP-side
...
The separate RMSNorm-input opening-layout follow-up tracks that narrow attack.
...
- The attention-derived d128 path now reaches down projection: derived hidden
  activation
  `blake2b-256:8603048df50e0249baaae9a5be031a09a05c5df8152a8a4df61809f0d9568cd4`
  ...
  The gate checks `65,536` down-projection multiplication rows plus `128`
...
- The attention-derived d128 path now has a committed block statement chain:
  `6` checked slice artifacts, `11` commitment edges, `199,553` accounted
  relation rows, and block statement commitment
...
- The one-transformer-block surface scorecard now consumes the
  ...
  statement receipt over its input contract: `6` source artifacts, `6`
  component rows, `194,097` local attention-fusion JSON proof-byte savings,
  `197,504` d128 receipt-chain rows, `199,553` attention-derived
  statement-chain rows, a `0.174986x` compressed/source statement-chain ratio,
  and an `807`-byte Groth16 statement receipt with `17` public signals and
  `40 / 40` mutation rejection. This remains a no-go for a matched
  NANOZK-style layer proof, native outer proof, verifier-time benchmark, or full
  inference; see
...
- The attention-derived d128 statement chain now has a compressed
  ...
  `0.174986x`. The gate rejects `22 / 22` local mutations, including
  recommitted public-input drift. This is artifact/transcript compression only;
...
- Step counts:
  `9` policy rows, `3` FRI query locations per row, `18` mutation cases, `15`
...
- Step counts: `13` Python mutation cases and `20` Python unit tests.
...
`495,854` raw bytes against a matched source-plus-sidecar frontier of `539,670`
raw bytes, saving `43,816` bytes at `8,832` lookup claims and `16,384` trace
rows. From d128 four-head seq32 to d128 four-head seq64, lookup claims grow
`3.729730x` and trace rows grow `4.000000x`, while fused raw proof bytes grow
`1.064910x`.

Updated source-of-truth artifacts:

- Route matrix: `28` checked matched rows, `719,769` aggregate raw proof-byte
  savings.
- Fuller grid: `28 / 100` proved cells, `72 / 100` missing cells.

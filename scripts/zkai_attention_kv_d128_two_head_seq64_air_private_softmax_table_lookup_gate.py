#!/usr/bin/env python3
"""Checked AIR-constrained d128 two-head seq64 Softmax-table lookup sidecar gate for issue #715.

This gate records the narrow positive result: the existing native d128 two-head seq64
...
LOOKUP_ENVELOPE_JSON = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-d128-two-head-seq64-softmax-table-logup-sidecar-proof-2026-05.envelope.json"
SOURCE_INPUT_SCRIPT = ROOT / "scripts" / "zkai_attention_kv_stwo_native_d128_two_head_seq64_bounded_softmax_table_proof_input.py"
JSON_OUT = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-d128-two-head-seq64-softmax-table-logup-sidecar-gate-2026-05.json"
TSV_OUT = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-d128-two-head-seq64-softmax-table-logup-sidecar-gate-2026-05.tsv"

MAX_SOURCE_INPUT_JSON_BYTES = 134_217_728
MAX_LOOKUP_ENVELOPE_JSON_BYTES = 134_217_728

SCHEMA = "zkai-attention-kv-stwo-native-d128-two-head-seq64-softmax-table-logup-sidecar-gate-v1"
ISSUE = 715
SOURCE_ISSUE = 715
DECISION = "GO_NATIVE_STWO_AIR_CONSTRAINED_D128_TWO_HEAD_SEQ64_SOFTMAX_TABLE_LOOKUP_RELATION_SIDECAR"
CLAIM_BOUNDARY = (
    "NATIVE_STWO_D128_TWO_HEAD_SEQ64_BOUNDED_SOFTMAX_TABLE_LOOKUP_MEMBERSHIP_CONSTRAINED_BY_LOGUP_SIDECAR_"
...
NEXT_BACKEND_STEP = (
    "use this source-plus-sidecar comparator as the matched control for the existing seq64 fused native route"
)
TIMING_POLICY = "no_new_timing_proof_existence_and_relation_gate_only"
LOOKUP_VERIFY_TIMEOUT_SECONDS = 420

SOURCE_DECISION = "GO_INPUT_FOR_STWO_NATIVE_ATTENTION_KV_D128_TWO_HEAD_SEQ64_BOUNDED_SOFTMAX_TABLE_AIR_PROOF"
...
LOOKUP_PROOF_VERSION = "stwo-attention-kv-d128-two-head-seq64-softmax-table-logup-sidecar-proof-v1"
LOOKUP_STATEMENT_VERSION = "zkai-attention-kv-stwo-native-d128-two-head-seq64-softmax-table-logup-sidecar-statement-v1"
LOOKUP_SEMANTIC_SCOPE = "d128_two_head_seq64_bounded_softmax_table_membership_constrained_by_native_stwo_logup_sidecar"
LOOKUP_VERIFIER_DOMAIN = "ptvm:zkai:attention-kv-stwo-native-d128-two-head-seq64-softmax-table-logup-sidecar:v1"
LOOKUP_TARGET_ID = "attention-kv-d128-two-head-seq64-causal-mask-bounded-softmax-table-logup-sidecar-v1"
LOOKUP_RELATION = "AttentionKvD128TwoHeadSeq64SoftmaxTableLookupRelation"
LOOKUP_RELATION_WIDTH = 2
LOOKUP_PROOF_SIZE_BYTES = 45_414
LOOKUP_ENVELOPE_SIZE_BYTES = 68_536_643
...
LOOKUP_TABLE_MULTIPLICITIES = (
    ...
    {"gap": 8, "weight": 16, "multiplicity": 4277},
)
EXPECTED_LOOKUP_TABLE_MULTIPLICITIES = LOOKUP_TABLE_MULTIPLICITIES

FIXED_D64_TWO_HEAD_LOOKUP_CLAIMS = 4_416
FIXED_D64_TWO_HEAD_LOOKUP_PROOF_SIZE_BYTES = 42_567
FIXED_D64_TWO_HEAD_LOOKUP_ENVELOPE_SIZE_BYTES = 35_881_481
...
def verify_lookup_envelope_bytes_with_native_cli(envelope_bytes: bytes, label: str) -> None:
    ...
    command = [
        ...
        "stwo-backend",
        "--bin",
        "zkai_attention_kv_native_d128_two_head_seq64_softmax_table_lookup_proof",
        "--",
        "verify",
        str(tmp_path),
    ]
...
def build_payload() -> dict[str, Any]:
    ...
    payload["gate_commitment"] = blake2b_commitment(
        ...
        "ptvm:zkai:attention-kv-d128-two-head-seq64-softmax-table-logup-sidecar-gate:v1",
    )

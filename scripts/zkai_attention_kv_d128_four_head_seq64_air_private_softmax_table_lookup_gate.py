#!/usr/bin/env python3
"""Checked AIR-constrained d128 four-head seq64 Softmax-table lookup sidecar gate for issue #715.

This gate records the narrow positive result: the existing native d128 four-head seq64
...
LOOKUP_ENVELOPE_JSON = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-d128-four-head-seq64-softmax-table-logup-sidecar-proof-2026-05.envelope.json"
SOURCE_INPUT_SCRIPT = ROOT / "scripts" / "zkai_attention_kv_stwo_native_d128_four_head_seq64_bounded_softmax_table_proof_input.py"
JSON_OUT = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-d128-four-head-seq64-softmax-table-logup-sidecar-gate-2026-05.json"
TSV_OUT = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-d128-four-head-seq64-softmax-table-logup-sidecar-gate-2026-05.tsv"

MAX_SOURCE_INPUT_JSON_BYTES = 268_435_456
MAX_LOOKUP_ENVELOPE_JSON_BYTES = 268_435_456

SCHEMA = "zkai-attention-kv-stwo-native-d128-four-head-seq64-softmax-table-logup-sidecar-gate-v1"
ISSUE = 715
SOURCE_ISSUE = 715
DECISION = "GO_NATIVE_STWO_AIR_CONSTRAINED_D128_FOUR_HEAD_SEQ64_SOFTMAX_TABLE_LOOKUP_RELATION_SIDECAR"
CLAIM_BOUNDARY = (
    "NATIVE_STWO_D128_FOUR_HEAD_SEQ64_BOUNDED_SOFTMAX_TABLE_LOOKUP_MEMBERSHIP_CONSTRAINED_BY_LOGUP_SIDECAR_"
...
SOURCE_DECISION = "GO_INPUT_FOR_STWO_NATIVE_ATTENTION_KV_D128_FOUR_HEAD_SEQ64_BOUNDED_SOFTMAX_TABLE_AIR_PROOF"
...
LOOKUP_PROOF_VERSION = "stwo-attention-kv-d128-four-head-seq64-softmax-table-logup-sidecar-proof-v1"
LOOKUP_STATEMENT_VERSION = "zkai-attention-kv-stwo-native-d128-four-head-seq64-softmax-table-logup-sidecar-statement-v1"
LOOKUP_SEMANTIC_SCOPE = "d128_four_head_seq64_bounded_softmax_table_membership_constrained_by_native_stwo_logup_sidecar"
LOOKUP_VERIFIER_DOMAIN = "ptvm:zkai:attention-kv-stwo-native-d128-four-head-seq64-softmax-table-logup-sidecar:v1"
LOOKUP_TARGET_ID = "attention-kv-d128-four-head-seq64-causal-mask-bounded-softmax-table-logup-sidecar-v1"
LOOKUP_RELATION = "AttentionKvD128FourHeadSeq64SoftmaxTableLookupRelation"
LOOKUP_RELATION_WIDTH = 2
LOOKUP_PROOF_SIZE_BYTES = 49_363
LOOKUP_ENVELOPE_SIZE_BYTES = 137_403_230
...
LOOKUP_TABLE_MULTIPLICITIES = (
    ...
    {"gap": 8, "weight": 16, "multiplicity": 8557},
)
EXPECTED_LOOKUP_TABLE_MULTIPLICITIES = LOOKUP_TABLE_MULTIPLICITIES

FIXED_D64_FOUR_HEAD_LOOKUP_CLAIMS = 8_832
FIXED_D64_FOUR_HEAD_LOOKUP_PROOF_SIZE_BYTES = 43_147
FIXED_D64_FOUR_HEAD_LOOKUP_ENVELOPE_SIZE_BYTES = 71_779_632
...
EXPECTED_MUTATION_NAMES = (
    ...
    "fixed_d64_four_head_comparison_metric_smuggling",
...
TSV_COLUMNS = (
    ...
    "lookup_claims",
    "fixed_d64_four_head_lookup_claims",
    "claim_count_ratio",
    "lookup_proof_size_bytes",
    "fixed_d64_four_head_lookup_proof_size_bytes",
    "proof_size_ratio",
    "lookup_envelope_size_bytes",
    "fixed_d64_four_head_lookup_envelope_size_bytes",
    "envelope_size_ratio",
...
def fixed_d64_four_head_comparison() -> dict[str, Any]:
    return {
        "fixed_d64_four_head_lookup_claims": FIXED_D64_FOUR_HEAD_LOOKUP_CLAIMS,
        "fixed_d64_four_head_lookup_proof_size_bytes": FIXED_D64_FOUR_HEAD_LOOKUP_PROOF_SIZE_BYTES,
        "fixed_d64_four_head_lookup_envelope_size_bytes": FIXED_D64_FOUR_HEAD_LOOKUP_ENVELOPE_SIZE_BYTES,
        ...
        "claim_count_ratio": format_ratio(SOURCE_SCORE_ROWS, FIXED_D64_FOUR_HEAD_LOOKUP_CLAIMS),
        "proof_size_ratio": format_ratio(LOOKUP_PROOF_SIZE_BYTES, FIXED_D64_FOUR_HEAD_LOOKUP_PROOF_SIZE_BYTES),
        "envelope_size_ratio": format_ratio(LOOKUP_ENVELOPE_SIZE_BYTES, FIXED_D64_FOUR_HEAD_LOOKUP_ENVELOPE_SIZE_BYTES),
    }
...
def build_payload() -> dict[str, Any]:
    ...
    payload: dict[str, Any] = {
        ...
        "fixed_d64_four_head_comparison": fixed_d64_four_head_comparison(),
    ...
    payload["gate_commitment"] = blake2b_commitment(
        {
            ...
            "proof_size_ratio": payload["fixed_d64_four_head_comparison"]["proof_size_ratio"],
        ...
        "ptvm:zkai:attention-kv-d128-four-head-seq64-softmax-table-logup-sidecar-gate:v1",
    )
...
def mutate_payload(payload: dict[str, Any], name: str) -> dict[str, Any]:
    ...
    elif name == "fixed_d64_four_head_comparison_metric_smuggling":
        mutated["fixed_d64_four_head_comparison"]["proof_size_ratio"] = "1.000000"
...
def validate_payload(payload: Any, *, allow_missing_mutation_summary: bool = False) -> None:
    ...
    allowed = {
        ...
        "timing_policy",
        "lookup_receipt",
        "fixed_d64_four_head_comparison",
        "fused_comparator",
        "non_claims",
        "validation_commands",
        "gate_commitment",
...
def to_tsv(payload: dict[str, Any]) -> str:
    ...
    comparison = payload["fixed_d64_four_head_comparison"]
    row = {
        "decision": payload["decision"],
        "lookup_status": payload["lookup_status"],
        "fused_component_status": payload["fused_component_status"],
        "lookup_claims": receipt["lookup_claims"],
        "fixed_d64_four_head_lookup_claims": comparison["fixed_d64_four_head_lookup_claims"],
        "claim_count_ratio": comparison["claim_count_ratio"],
        "lookup_proof_size_bytes": receipt["lookup_proof_size_bytes"],
        "fixed_d64_four_head_lookup_proof_size_bytes": comparison["fixed_d64_four_head_lookup_proof_size_bytes"],
        "proof_size_ratio": comparison["proof_size_ratio"],
        "lookup_envelope_size_bytes": receipt["lookup_envelope_size_bytes"],
        "fixed_d64_four_head_lookup_envelope_size_bytes": comparison["fixed_d64_four_head_lookup_envelope_size_bytes"],

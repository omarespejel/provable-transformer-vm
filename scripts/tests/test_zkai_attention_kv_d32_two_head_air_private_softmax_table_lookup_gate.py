...
from scripts import zkai_attention_kv_d32_two_head_air_private_softmax_table_lookup_gate as gate
...
class AttentionKvAirPrivateSoftmaxTableLookupGateTests(unittest.TestCase):
    ...
    def test_build_payload_records_logup_sidecar_go(self):
        ...
        self.assertEqual(receipt["lookup_proof_size_bytes"], 18137)
        self.assertEqual(receipt["lookup_envelope_size_bytes"], 649773)
        ...
        self.assertEqual(receipt["table_multiplicities"][-1]["multiplicity"], 79)
        self.assertEqual(payload["single_head_comparison"]["single_head_lookup_claims"], 52)
        self.assertEqual(payload["single_head_comparison"]["proof_size_ratio"], "1.165467")
    ...
    def test_tsv_summary_matches_payload(self):
        ...
        self.assertIn("18137", tsv)
        self.assertIn("1.165467", tsv)

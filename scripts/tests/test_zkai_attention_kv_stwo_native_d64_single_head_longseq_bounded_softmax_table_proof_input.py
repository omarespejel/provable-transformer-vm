...
from scripts import zkai_attention_kv_stwo_native_d64_single_head_longseq_bounded_softmax_table_proof_input as gate
...
class AttentionKvBoundedSoftmaxTableInputTests(unittest.TestCase):
    def test_payload_builds_checked_bounded_softmax_table_attention_surface(self):
        ...
        self.assertEqual(payload["key_width"], 64)
        self.assertEqual(payload["value_width"], 64)
        ...
        self.assertEqual(gate.score_row_material_width(), 524)
        self.assertEqual(

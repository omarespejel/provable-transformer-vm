...
class AttentionKvFusedSoftmaxTableRouteMatrixGateTests(unittest.TestCase):
    ...
    def test_records_controlled_axis_matrix_with_matched_eight_head_comparator(self):
        ...
        self.assertEqual(result["profiles_checked"], 24)
        self.assertEqual(result["matched_comparator_profiles"], 24)
    ...
    def test_aggregate_metrics_are_checked(self):
        ...
        self.assertEqual(metrics["total_lookup_claims"], 27500)
        self.assertEqual(metrics["total_trace_rows"], 47680)
        self.assertEqual(metrics["total_fused_proof_size_bytes"], 3306650)
        self.assertEqual(metrics["max_fused_proof_size_bytes"], 276503)
        self.assertEqual(metrics["matched_source_plus_sidecar_raw_proof_bytes_total"], 3870594)
        self.assertEqual(metrics["matched_fused_proof_size_bytes_total"], 3306650)
        self.assertEqual(metrics["matched_fused_savings_bytes_total"], 563944)

...
class AttentionKvFusedSoftmaxTableRouteMatrixGateTests(unittest.TestCase):
    ...
    def test_records_controlled_axis_matrix_with_matched_eight_head_comparator(self):
        ...
        self.assertEqual(result["profiles_checked"], 13)
        self.assertEqual(result["matched_comparator_profiles"], 13)
    ...
    def test_aggregate_metrics_are_checked(self):
        ...
        self.assertEqual(metrics["total_lookup_claims"], 4116)
        self.assertEqual(metrics["total_trace_rows"], 5952)
        self.assertEqual(metrics["total_fused_proof_size_bytes"], 995026)
        self.assertEqual(metrics["max_fused_proof_size_bytes"], 132543)
        self.assertEqual(metrics["matched_source_plus_sidecar_raw_proof_bytes_total"], 1235025)
        self.assertEqual(metrics["matched_fused_proof_size_bytes_total"], 995026)
        self.assertEqual(metrics["matched_fused_savings_bytes_total"], 239999)

...
from scripts import zkai_attention_kv_d128_single_head_seq16_air_private_softmax_table_lookup_gate as gate
...
class AttentionKvAirPrivateSoftmaxTableLookupGateTests(unittest.TestCase):
    ...
    def test_build_payload_records_logup_sidecar_go(self):
        ...
        self.assertEqual(receipt["lookup_proof_size_bytes"], 23052)
        self.assertEqual(receipt["lookup_envelope_size_bytes"], 2896476)
        ...
        self.assertEqual(receipt["table_multiplicities"][-1]["multiplicity"], 148)

...
class AttentionKvFullerCrossingGridGateTests(unittest.TestCase):
    ...
    def test_records_45_cell_grid_with_14_proved_and_31_missing(self):
        result = self.result
        ...
        self.assertEqual(result["summary"]["proved_cell_count"], 14)
        self.assertEqual(result["summary"]["missing_cell_count"], 31)
        self.assertEqual(result["summary"]["coverage_share"], 0.311111)
    ...
    def test_summary_keeps_go_and_no_go_boundary_sharp(self):
        ...
        self.assertEqual(summary["proved_crossing_cell_count"], 7)
        self.assertEqual(summary["proved_all_axis_cell_count"], 3)
        self.assertEqual(summary["missing_all_axis_cell_count"], 13)
        self.assertEqual(summary["proved_counts_by_width"], {"16": 3, "32": 4, "8": 7})
        self.assertEqual(summary["proved_counts_by_head_count"], {"1": 3, "16": 1, "2": 8, "4": 1, "8": 1})
        self.assertEqual(summary["proved_counts_by_steps_per_head"], {"16": 3, "32": 2, "8": 9})

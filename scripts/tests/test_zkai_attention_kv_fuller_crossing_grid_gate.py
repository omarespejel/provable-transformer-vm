...
class AttentionKvFullerCrossingGridGateTests(unittest.TestCase):
    ...
    def test_proved_cells_are_exactly_the_checked_route_matrix_cells(self):
        ...
        self.assertEqual(by_cell["d128_h1_seq16"]["profile_id"], "d128_single_head_seq16")
        self.assertEqual(by_cell["d128_h1_seq16"]["pressure_axes"], ["width", "sequence"])
        self.assertEqual(by_cell["d128_h1_seq16"]["lookup_claims"], 168)
        self.assertEqual(by_cell["d128_h1_seq16"]["trace_rows"], 256)
        self.assertEqual(by_cell["d128_h1_seq16"]["fused_proof_size_bytes"], 380342)
        self.assertEqual(by_cell["d128_h1_seq16"]["source_plus_sidecar_raw_proof_bytes"], 397313)
        self.assertEqual(by_cell["d128_h1_seq16"]["fused_to_source_plus_sidecar_ratio"], 0.957286)
        self.assertEqual(by_cell["d128_h2_seq32"]["profile_id"], "d128_two_head_seq32")
        self.assertEqual(by_cell["d128_h2_seq32"]["pressure_axes"], ["width", "head", "sequence"])
        self.assertEqual(by_cell["d128_h2_seq32"]["lookup_claims"], 1184)
        self.assertEqual(by_cell["d128_h2_seq32"]["fused_proof_size_bytes"], 445888)
        self.assertEqual(by_cell["d128_h2_seq32"]["source_plus_sidecar_raw_proof_bytes"], 478276)
        self.assertEqual(by_cell["d128_h2_seq32"]["fused_to_source_plus_sidecar_ratio"], 0.932282)
        self.assertEqual(by_cell["d128_h2_seq64"]["profile_id"], "d128_two_head_seq64")
        self.assertEqual(by_cell["d128_h2_seq64"]["pressure_axes"], ["width", "head", "sequence"])
        self.assertEqual(by_cell["d128_h2_seq64"]["lookup_claims"], 4416)
        self.assertEqual(by_cell["d128_h2_seq64"]["trace_rows"], 8192)
        self.assertEqual(by_cell["d128_h2_seq64"]["fused_proof_size_bytes"], 481870)
        self.assertEqual(by_cell["d128_h2_seq64"]["source_plus_sidecar_raw_proof_bytes"], 522187)
        self.assertEqual(by_cell["d128_h2_seq64"]["fused_to_source_plus_sidecar_ratio"], 0.922792)
        self.assertEqual(by_cell["d128_h4_seq32"]["profile_id"], "d128_four_head_seq32")
        self.assertEqual(by_cell["d128_h4_seq32"]["pressure_axes"], ["width", "head", "sequence"])
        self.assertEqual(by_cell["d128_h4_seq32"]["lookup_claims"], 2368)
        self.assertEqual(by_cell["d128_h4_seq32"]["trace_rows"], 4096)
    ...
    def test_write_json_and_tsv_round_trip(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(rows[81]["cell_id"], "d128_h1_seq16")
            self.assertEqual(rows[81]["status"], gate.PROVED_STATUS)
            self.assertEqual(rows[81]["profile_id"], "d128_single_head_seq16")
            self.assertEqual(rows[81]["fused_to_source_plus_sidecar_ratio"], "0.957286")
            self.assertEqual(rows[86]["cell_id"], "d128_h2_seq32")
            self.assertEqual(rows[86]["profile_id"], "d128_two_head_seq32")
            self.assertEqual(rows[86]["fused_to_source_plus_sidecar_ratio"], "0.932282")
            self.assertEqual(rows[87]["cell_id"], "d128_h2_seq64")
            self.assertEqual(rows[87]["profile_id"], "d128_two_head_seq64")
            self.assertEqual(rows[87]["fused_to_source_plus_sidecar_ratio"], "0.922792")

...
class AttentionKvFullerCrossingGridGateTests(unittest.TestCase):
    ...
    def test_records_60_cell_grid_with_16_proved_and_44_missing(self):
        result = self.result
        ...
        self.assertEqual(result["summary"]["proved_cell_count"], 16)
        self.assertEqual(result["summary"]["missing_cell_count"], 44)
    ...
    def test_summary_keeps_go_and_no_go_boundary_sharp(self):
        ...
        self.assertEqual(summary["proved_crossing_cell_count"], 9)
        self.assertEqual(summary["proved_all_axis_cell_count"], 5)
        self.assertEqual(summary["missing_all_axis_cell_count"], 19)
        self.assertEqual(summary["proved_counts_by_width"], {"16": 3, "32": 4, "64": 2, "8": 7})
        self.assertEqual(summary["proved_counts_by_head_count"], {"1": 3, "16": 1, "2": 10, "4": 1, "8": 1})
        self.assertEqual(summary["proved_counts_by_steps_per_head"], {"16": 4, "32": 3, "8": 9})

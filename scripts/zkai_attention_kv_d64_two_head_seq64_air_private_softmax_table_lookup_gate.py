#!/usr/bin/env python3
"""Checked AIR-constrained d64 two-head seq64 Softmax-table lookup sidecar gate for issue #715.

This gate records the narrow positive result: the existing native d64 two-head seq64
...
LOOKUP_ENVELOPE_JSON = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-d64-two-head-seq64-softmax-table-logup-sidecar-proof-2026-05.envelope.json"
SOURCE_INPUT_SCRIPT = ROOT / "scripts" / "zkai_attention_kv_stwo_native_d64_two_head_seq64_bounded_softmax_table_proof_input.py"
JSON_OUT = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-d64-two-head-seq64-softmax-table-logup-sidecar-gate-2026-05.json"
TSV_OUT = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-d64-two-head-seq64-softmax-table-logup-sidecar-gate-2026-05.tsv"

MAX_SOURCE_INPUT_JSON_BYTES = 134_217_728
MAX_LOOKUP_ENVELOPE_JSON_BYTES = 134_217_728

SCHEMA = "zkai-attention-kv-stwo-native-d64-two-head-seq64-softmax-table-logup-sidecar-gate-v1"
ISSUE = 715
SOURCE_ISSUE = 715
DECISION = "GO_NATIVE_STWO_AIR_CONSTRAINED_D64_TWO_HEAD_SEQ64_SOFTMAX_TABLE_LOOKUP_RELATION_SIDECAR"
CLAIM_BOUNDARY = (
    "NATIVE_STWO_D64_TWO_HEAD_SEQ64_BOUNDED_SOFTMAX_TABLE_LOOKUP_MEMBERSHIP_CONSTRAINED_BY_LOGUP_SIDECAR_"
...
NEXT_BACKEND_STEP = (
    "use this source-plus-sidecar comparator as the matched control for the d64 two-head seq64 fused native route and crossing-grid row"
)
...
LOOKUP_PROOF_VERSION = "stwo-attention-kv-d64-two-head-seq64-softmax-table-logup-sidecar-proof-v1"
LOOKUP_STATEMENT_VERSION = "zkai-attention-kv-stwo-native-d64-two-head-seq64-softmax-table-logup-sidecar-statement-v1"
LOOKUP_SEMANTIC_SCOPE = "d64_two_head_seq64_bounded_softmax_table_membership_constrained_by_native_stwo_logup_sidecar"
LOOKUP_VERIFIER_DOMAIN = "ptvm:zkai:attention-kv-stwo-native-d64-two-head-seq64-softmax-table-logup-sidecar:v1"
LOOKUP_TARGET_ID = "attention-kv-d64-two-head-seq64-causal-mask-bounded-softmax-table-logup-sidecar-v1"
LOOKUP_RELATION = "AttentionKvD64TwoHeadSeq64SoftmaxTableLookupRelation"
LOOKUP_RELATION_WIDTH = 2
LOOKUP_PROOF_SIZE_BYTES = 42_567
LOOKUP_ENVELOPE_SIZE_BYTES = 35_881_481
LOOKUP_PROOF_COMMITMENTS = 4
LOOKUP_TRACE_COMMITMENTS = 3
LOOKUP_TABLE_MULTIPLICITIES = (
    {"gap": 0, "weight": 256, "multiplicity": 133},
    {"gap": 1, "weight": 181, "multiplicity": 5},
    {"gap": 2, "weight": 128, "multiplicity": 3},
    {"gap": 3, "weight": 91, "multiplicity": 2},
    {"gap": 4, "weight": 64, "multiplicity": 2},
    {"gap": 5, "weight": 45, "multiplicity": 4},
    {"gap": 6, "weight": 32, "multiplicity": 1},
    {"gap": 7, "weight": 23, "multiplicity": 1},
    {"gap": 8, "weight": 16, "multiplicity": 4265},
)
EXPECTED_LOOKUP_TABLE_MULTIPLICITIES = LOOKUP_TABLE_MULTIPLICITIES

# Baseline: checked d64 two-head seq32 LogUp sidecar row.
BASELINE_D64_TWO_HEAD_SEQ32_LOOKUP_CLAIMS = 1184
BASELINE_D64_TWO_HEAD_SEQ32_LOOKUP_PROOF_SIZE_BYTES = 36_400
BASELINE_D64_TWO_HEAD_SEQ32_LOOKUP_ENVELOPE_SIZE_BYTES = 9_978_658
CLAIM_COUNT_RATIO = "3.729730"
PROOF_SIZE_RATIO = "1.169423"
ENVELOPE_SIZE_RATIO = "3.595822"
...
FUSED_TO_SOURCE_PLUS_SIDECAR_RATIO = "0.888152"
...
EXPECTED_MUTATION_NAMES = (
    ...
    "baseline_d64_two_head_seq32_comparison_metric_smuggling",
...
TSV_COLUMNS = (
    ...
    "lookup_claims",
    "baseline_d64_two_head_seq32_lookup_claims",
    "claim_count_ratio",
    "lookup_proof_size_bytes",
    "baseline_d64_two_head_seq32_lookup_proof_size_bytes",
    "proof_size_ratio",
    "lookup_envelope_size_bytes",
    "baseline_d64_two_head_seq32_lookup_envelope_size_bytes",
    "envelope_size_ratio",
...
def verify_lookup_envelope_bytes_with_native_cli(envelope_bytes: bytes, label: str) -> None:
    ...
    command = [
        ...
        "stwo-backend",
        "--bin",
        "zkai_attention_kv_native_d64_two_head_seq64_softmax_table_lookup_proof",
        "--",
        "verify",
        str(tmp_path),
    ]
...
def baseline_d64_two_head_seq32_comparison() -> dict[str, Any]:
    return {
        "baseline_d64_two_head_seq32_lookup_claims": BASELINE_D64_TWO_HEAD_SEQ32_LOOKUP_CLAIMS,
        "baseline_d64_two_head_seq32_lookup_proof_size_bytes": BASELINE_D64_TWO_HEAD_SEQ32_LOOKUP_PROOF_SIZE_BYTES,
        "baseline_d64_two_head_seq32_lookup_envelope_size_bytes": BASELINE_D64_TWO_HEAD_SEQ32_LOOKUP_ENVELOPE_SIZE_BYTES,
...
def build_payload() -> dict[str, Any]:
    ...
    payload: dict[str, Any] = {
        ...
        "baseline_d64_two_head_seq32_comparison": baseline_d64_two_head_seq32_comparison(),
    ...
    payload["gate_commitment"] = blake2b_commitment(
        {
            ...
            "proof_size_ratio": payload["baseline_d64_two_head_seq32_comparison"]["proof_size_ratio"],
        ...
        "ptvm:zkai:attention-kv-d64-two-head-seq64-softmax-table-logup-sidecar-gate:v1",
    )
...
def mutate_payload(payload: dict[str, Any], name: str) -> dict[str, Any]:
    ...
    elif name == "baseline_d64_two_head_seq32_comparison_metric_smuggling":
        mutated["baseline_d64_two_head_seq32_comparison"]["proof_size_ratio"] = "1.000000"
...
def validate_payload(payload: Any, *, allow_missing_mutation_summary: bool = False) -> None:
    ...
    allowed = {
        ...
        "timing_policy",
        "lookup_receipt",
        "baseline_d64_two_head_seq32_comparison",
        "fused_comparator",
        "non_claims",
        "validation_commands",
        "gate_commitment",
...
def to_tsv(payload: dict[str, Any]) -> str:
    ...
    comparison = payload["baseline_d64_two_head_seq32_comparison"]
    row = {
        "decision": payload["decision"],
        "lookup_status": payload["lookup_status"],
        "fused_component_status": payload["fused_component_status"],
        "lookup_claims": receipt["lookup_claims"],
        "baseline_d64_two_head_seq32_lookup_claims": comparison["baseline_d64_two_head_seq32_lookup_claims"],
        "claim_count_ratio": comparison["claim_count_ratio"],
        "lookup_proof_size_bytes": receipt["lookup_proof_size_bytes"],
        "baseline_d64_two_head_seq32_lookup_proof_size_bytes": comparison["baseline_d64_two_head_seq32_lookup_proof_size_bytes"],
        "proof_size_ratio": comparison["proof_size_ratio"],
        "lookup_envelope_size_bytes": receipt["lookup_envelope_size_bytes"],
        "baseline_d64_two_head_seq32_lookup_envelope_size_bytes": comparison["baseline_d64_two_head_seq32_lookup_envelope_size_bytes"],

#!/usr/bin/env python3
"""Checked AIR-constrained d128 single-head seq16 Softmax-table lookup sidecar gate for issue #715.

This gate records the narrow positive result: the native d128 single-head seq16 bounded
...
LOOKUP_ENVELOPE_JSON = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-d128-single-head-seq16-softmax-table-logup-sidecar-proof-2026-05.envelope.json"
...
JSON_OUT = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-d128-single-head-seq16-softmax-table-logup-sidecar-gate-2026-05.json"
TSV_OUT = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-d128-single-head-seq16-softmax-table-logup-sidecar-gate-2026-05.tsv"

MAX_SOURCE_INPUT_JSON_BYTES = 8_388_608
MAX_LOOKUP_ENVELOPE_JSON_BYTES = 8_388_608

SCHEMA = "zkai-attention-kv-stwo-native-d128-single-head-seq16-softmax-table-logup-sidecar-gate-v1"
ISSUE = 715
SOURCE_ISSUE = 715
DECISION = "GO_NATIVE_STWO_AIR_CONSTRAINED_SOFTMAX_TABLE_LOOKUP_RELATION_SIDECAR"
CLAIM_BOUNDARY = (
    "NATIVE_STWO_D128_SINGLE_HEAD_SEQ16_BOUNDED_SOFTMAX_TABLE_LOOKUP_MEMBERSHIP_CONSTRAINED_BY_LOGUP_SIDECAR_"
...
SOURCE_DECISION = "GO_INPUT_FOR_STWO_NATIVE_ATTENTION_KV_D128_SINGLE_HEAD_SEQ16_BOUNDED_SOFTMAX_TABLE_AIR_PROOF"
...
LOOKUP_PROOF_VERSION = "stwo-attention-kv-d128-single-head-seq16-softmax-table-logup-sidecar-proof-v1"
LOOKUP_STATEMENT_VERSION = "zkai-attention-kv-stwo-native-d128-single-head-seq16-softmax-table-logup-sidecar-statement-v1"
LOOKUP_SEMANTIC_SCOPE = "d128_single_head_seq16_bounded_softmax_table_membership_constrained_by_native_stwo_logup_sidecar"
LOOKUP_VERIFIER_DOMAIN = "ptvm:zkai:attention-kv-stwo-native-d128-single-head-seq16-softmax-table-logup-sidecar:v1"
LOOKUP_TARGET_ID = "attention-kv-d128-single-head-seq16-causal-mask-bounded-softmax-table-logup-sidecar-v1"
LOOKUP_RELATION = "AttentionKvD128SingleHeadSeq16SoftmaxTableLookupRelation"
LOOKUP_RELATION_WIDTH = 2
LOOKUP_PROOF_SIZE_BYTES = 23_052
LOOKUP_ENVELOPE_SIZE_BYTES = 2_896_476
...
VALIDATION_COMMANDS = (
    "cargo +nightly-2025-07-14 test --locked attention_kv_d128_single_head_seq16_softmax_table_lookup --lib --features stwo-backend",
    "cargo +nightly-2025-07-14 run --locked --features stwo-backend --bin zkai_attention_kv_native_d128_single_head_seq16_softmax_table_lookup_proof -- prove docs/engineering/evidence/zkai-attention-kv-stwo-native-d128-single-head-seq16-bounded-softmax-table-proof-2026-05.json docs/engineering/evidence/zkai-attention-kv-stwo-native-d128-single-head-seq16-softmax-table-logup-sidecar-proof-2026-05.envelope.json",
    ...
    "python3.10 scripts/zkai_attention_kv_d128_single_head_seq16_air_private_softmax_table_lookup_gate.py --write-json docs/engineering/evidence/zkai-attention-kv-stwo-native-d128-single-head-seq16-softmax-table-logup-sidecar-gate-2026-05.json --write-tsv docs/engineering/evidence/zkai-attention-kv-stwo-native-d128-single-head-seq16-softmax-table-logup-sidecar-gate-2026-05.tsv",
...
def verify_lookup_envelope_bytes_with_native_cli(envelope_bytes: bytes, label: str) -> None:
    ...
    command = [
        ...
        "stwo-backend",
        "--bin",
        "zkai_attention_kv_native_d128_single_head_seq16_softmax_table_lookup_proof",
        "--",
        "verify",
        str(tmp_path),
    ]
...
def build_payload() -> dict[str, Any]:
    ...
    payload["gate_commitment"] = blake2b_commitment(
        ...
        "ptvm:zkai:attention-kv-d128-single-head-seq16-softmax-table-logup-sidecar-gate:v1",
    )
...
def mutate_payload(payload: dict[str, Any], name: str) -> dict[str, Any]:
    ...
    if name == "lookup_decision_relabeling":
        ...
        receipt["target_id"] = "attention-kv-d128-single-head-seq16-forged-lookup-sidecar"

...
DECISION = "GO_WIDE_GRID_SELECTOR_PROMOTE_D256_SEQ64_DECISION_GATE"
ROUTE_ID = "local_stwo_attention_kv_wide_grid_selector_from_checked_route_matrix"
ISSUE = 715
CLAIM_BOUNDARY = (
    "SELECTS_REMAINING_D64_D128_D256_ATTENTION_ROUTE_TARGETS_FROM_CHECKED_D8_D16_D32_D64_D128_D256_ROUTE_MATRIX;"
    "D64_HAS_PARTIAL_SOURCE_BACKED_ROWS_D128_HAS_SINGLE_HEAD_TWO_TWO_HEAD_ROWS_AND_TWO_FOUR_HEAD_ROWS_D256_HAS_ONE_TWO_HEAD_SEQ32_WIDTH_STRESS_ROW;"
...
FULLER_GRID_SHA256 = "2fc9660f6bfb6d9c7c25b31205b89e60591cc6a52f19bf7809d8af4e797684e0"
CLAIM_PACK_SHA256 = "ac787ee307eff902ca3cb095001445ac22ba81952b51f6bd90f0870bc27022d6"

REQUESTED_WIDTHS = (64, 128, 256)
REQUESTED_HEAD_COUNTS = (1, 2, 4)
REQUESTED_SEQUENCES = (16, 32, 64)
SUPPORTED_ATTENTION_WIDTHS = (8, 16, 32, 64, 128, 256)
...
NON_CLAIMS = (
    ...
    "does not widen the claim beyond checked d8, d16, d32, partial d64, partial d128, and one d256 attention row",
)
...
MUTATION_NAMES = (
    ...
    "d128_four_head_sequence_frontier_signal_drift",
    "d128_seq64_width_frontier_signal_drift",
    "d256_width_stress_signal_drift",
    "width_pressure_signal_drift",
    "d64_single_head_anchor_drift",
    "d128_single_head_width_anchor_drift",
...
def build_current_signal(route_matrix: dict[str, Any], fuller_grid: dict[str, Any]) -> dict[str, Any]:
    try:
        ...
        d128_single_seq16 = row_by_id(proved, "d128_single_head_seq16")
        d128_seq32 = row_by_id(proved, "d128_two_head_seq32")
        d128_four_seq32 = row_by_id(proved, "d128_four_head_seq32")
        d128_four_seq64 = row_by_id(proved, "d128_four_head_seq64")
        d128_seq64 = row_by_id(proved, "d128_two_head_seq64")
        d256_seq32 = row_by_id(proved, "d256_two_head_seq32")
        ...
        return {
            ...
            "d64_to_d128_single_head_seq16_width_anchor": {
                "lookup_claim_growth": ratio(d128_single_seq16["lookup_claims"], d64_single_seq16["lookup_claims"]),
                "trace_row_growth": ratio(d128_single_seq16["trace_rows"], d64_single_seq16["trace_rows"]),
                "source_raw_proof_growth": ratio(
                    d128_single_seq16["source_proof_size_bytes"], d64_single_seq16["source_proof_size_bytes"]
                ),
                "sidecar_raw_proof_growth": ratio(
                    d128_single_seq16["sidecar_proof_size_bytes"], d64_single_seq16["sidecar_proof_size_bytes"]
                ),
                "fused_raw_proof_growth": ratio(
                    d128_single_seq16["fused_proof_size_bytes"], d64_single_seq16["fused_proof_size_bytes"]
                ),
                "split_raw_proof_growth": ratio(
            ...
            "d64_to_d128_two_head_seq32_width_frontier": {
                "lookup_claim_growth": ratio(d128_seq32["lookup_claims"], d64_seq32["lookup_claims"]),
                "trace_row_growth": ratio(d128_seq32["trace_rows"], d64_seq32["trace_rows"]),
                "source_raw_proof_growth": ratio(
                    d128_seq32["source_proof_size_bytes"], d64_seq32["source_proof_size_bytes"]
                ),
                "sidecar_raw_proof_growth": ratio(
                    d128_seq32["sidecar_proof_size_bytes"], d64_seq32["sidecar_proof_size_bytes"]
                ),
                "fused_raw_proof_growth": ratio(
                    d128_seq32["fused_proof_size_bytes"], d64_seq32["fused_proof_size_bytes"]
                ),
                "split_raw_proof_growth": ratio(
                    d128_seq32["source_plus_sidecar_raw_proof_bytes"],
                    d64_seq32["source_plus_sidecar_raw_proof_bytes"],
                ),
                "saving_growth": ratio(
                    d128_seq32["fused_saves_vs_source_plus_sidecar_bytes"],
                    d64_seq32["fused_saves_vs_source_plus_sidecar_bytes"],
                ),
            },
            "d128_two_head_seq32_to_seq64": {
                "lookup_claim_growth": ratio(d128_seq64["lookup_claims"], d128_seq32["lookup_claims"]),
                "trace_row_growth": ratio(d128_seq64["trace_rows"], d128_seq32["trace_rows"]),
                "source_raw_proof_growth": ratio(
                    d128_seq64["source_proof_size_bytes"], d128_seq32["source_proof_size_bytes"]
                ),
                "sidecar_raw_proof_growth": ratio(
                    d128_seq64["sidecar_proof_size_bytes"], d128_seq32["sidecar_proof_size_bytes"]
                ),
                "fused_raw_proof_growth": ratio(
                    d128_seq64["fused_proof_size_bytes"], d128_seq32["fused_proof_size_bytes"]
                ),
                "split_raw_proof_growth": ratio(
                    d128_seq64["source_plus_sidecar_raw_proof_bytes"],
                    d128_seq32["source_plus_sidecar_raw_proof_bytes"],
                ),
                "saving_growth": ratio(
                    d128_seq64["fused_saves_vs_source_plus_sidecar_bytes"],
                    d128_seq32["fused_saves_vs_source_plus_sidecar_bytes"],
                ),
            },
            "d128_two_to_four_head_seq32": {
                "lookup_claim_growth": ratio(d128_four_seq32["lookup_claims"], d128_seq32["lookup_claims"]),
                "trace_row_growth": ratio(d128_four_seq32["trace_rows"], d128_seq32["trace_rows"]),
                "source_raw_proof_growth": ratio(
                    d128_four_seq32["source_proof_size_bytes"], d128_seq32["source_proof_size_bytes"]
                ),
                "sidecar_raw_proof_growth": ratio(
                    d128_four_seq32["sidecar_proof_size_bytes"], d128_seq32["sidecar_proof_size_bytes"]
                ),
                "fused_raw_proof_growth": ratio(
                    d128_four_seq32["fused_proof_size_bytes"], d128_seq32["fused_proof_size_bytes"]
                ),
                "split_raw_proof_growth": ratio(
            ...
            "d128_four_head_seq32_to_seq64": {
                "lookup_claim_growth": ratio(d128_four_seq64["lookup_claims"], d128_four_seq32["lookup_claims"]),
                "trace_row_growth": ratio(d128_four_seq64["trace_rows"], d128_four_seq32["trace_rows"]),
                "source_raw_proof_growth": ratio(
            ...
            "d64_to_d128_two_head_seq64_width_frontier": {
                "lookup_claim_growth": ratio(d128_seq64["lookup_claims"], d64_seq64["lookup_claims"]),
                "trace_row_growth": ratio(d128_seq64["trace_rows"], d64_seq64["trace_rows"]),
                "source_raw_proof_growth": ratio(
                    d128_seq64["source_proof_size_bytes"], d64_seq64["source_proof_size_bytes"]
                ),
                "sidecar_raw_proof_growth": ratio(
                    d128_seq64["sidecar_proof_size_bytes"], d64_seq64["sidecar_proof_size_bytes"]
                ),
                "fused_raw_proof_growth": ratio(
                    d128_seq64["fused_proof_size_bytes"], d64_seq64["fused_proof_size_bytes"]
                ),
                "split_raw_proof_growth": ratio(
                    d128_seq64["source_plus_sidecar_raw_proof_bytes"],
                    d64_seq64["source_plus_sidecar_raw_proof_bytes"],
            ...
            "d128_to_d256_two_head_seq32_width_stress": {
                "lookup_claim_growth": ratio(d256_seq32["lookup_claims"], d128_seq32["lookup_claims"]),
                "trace_row_growth": ratio(d256_seq32["trace_rows"], d128_seq32["trace_rows"]),
                "source_raw_proof_growth": ratio(
                    d256_seq32["source_proof_size_bytes"], d128_seq32["source_proof_size_bytes"]
                ),
                "sidecar_raw_proof_growth": ratio(
                    d256_seq32["sidecar_proof_size_bytes"], d128_seq32["sidecar_proof_size_bytes"]
                ),
                "fused_raw_proof_growth": ratio(
                    d256_seq32["fused_proof_size_bytes"], d128_seq32["fused_proof_size_bytes"]
                ),
                "split_raw_proof_growth": ratio(
                    d256_seq32["source_plus_sidecar_raw_proof_bytes"],
                    d128_seq32["source_plus_sidecar_raw_proof_bytes"],
                ),
                "saving_growth": ratio(
                    d256_seq32["fused_saves_vs_source_plus_sidecar_bytes"],
                    d128_seq32["fused_saves_vs_source_plus_sidecar_bytes"],
                ),
                "d256_raw_saving_bytes": d256_seq32["fused_saves_vs_source_plus_sidecar_bytes"],
                "d256_fused_to_split_ratio": d256_seq32["fused_to_source_plus_sidecar_ratio"],
            },
        }
...
def build_requested_grid_signal(current_signal: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "requested_rows": rows,
        "selector_status": "PARTIAL_D64_D128_AND_ONE_D256_SOURCE_BACKED_D256_SEQ64_MISSING",
    }
...
def build_candidate_order() -> list[dict[str, Any]]:
    return [
        {
            "priority": 1,
            "profile_id": "d256_h2_seq64",
            "key_width": 256,
            "head_count": 2,
            "steps_per_head": 64,
            "selector_status": "NEXT_D256_SEQUENCE_DECISION_GATE_AFTER_SEQ32_WIDTH_STRESS_GO",
            "why_this_row": "tests whether the d256 width-stress row keeps the sequence-axis amortization seen at d64 and d128",
            "go_gate": "d256 two-head seq64 validates with source, sidecar, fused, mutation, and accounting gates and either beats split or explains the boundary break",
            "no_go_gate": "d256 sequence pressure loses the boundary saving or requires special-casing that hides the proof-pressure signal",
        },
    ]
...
def build_interpretation() -> dict[str, Any]:
    return {
        "human_read": (
            ...
            "The d128 single-head seq16, two-head seq32, two-head seq64, four-head seq32, and four-head seq64 rows are now positive. "
            "The d256 two-head seq32 row also saves raw proof bytes, but its timing is not a speed win; the next check is d256 seq64."
        ),
        "paper_relevance": (
            "A paper-grade result needs the fused-vs-split saving to survive beyond isolated rows. "
            "The selector therefore records d256 seq32 as a passed width-stress gate and promotes the d256 sequence decision gate."
        ),
        "research_recommendation": (
            "Do d256_h2_seq64 next unless timing evidence says to pivot to boundary selection before scoped block work."
        ),
    }
...
def validate_payload(payload: dict[str, Any], expected_source_artifacts: list[dict[str, Any]]) -> None:
    ...
    if current.get("checked_attention_route_rows") != 30:
        raise ProofPressureWideGridSelectorError("current route row count drift")
    ...
    if current.get("raw_fused_bytes_total") != 6_397_632:
        raise ProofPressureWideGridSelectorError("raw fused total drift")
    if current.get("raw_split_bytes_total") != 7_164_515:
        raise ProofPressureWideGridSelectorError("raw split total drift")
    if current.get("raw_saving_bytes_total") != 766_883:
    ...
    if current.get("fully_missing_requested_widths") != []:
    ...
    if {key: d64_single_head_seq16.get(key) for key in expected_d64_single_head_seq16} != expected_d64_single_head_seq16:
        raise ProofPressureWideGridSelectorError("d64 single-head anchor signal drift")
    d128_single_head_seq16 = current.get("d64_to_d128_single_head_seq16_width_anchor")
    if not isinstance(d128_single_head_seq16, dict):
        raise ProofPressureWideGridSelectorError("d128 single-head width-anchor signal drift")
    expected_d128_single_head_seq16 = {
        "lookup_claim_growth": 1.0,
        "trace_row_growth": 1.0,
        "source_raw_proof_growth": 1.617272,
        "sidecar_raw_proof_growth": 1.004007,
        "fused_raw_proof_growth": 1.599924,
        "split_raw_proof_growth": 1.561918,
        "saving_growth": 1.019279,
    }
    if {key: d128_single_head_seq16.get(key) for key in expected_d128_single_head_seq16} != expected_d128_single_head_seq16:
        raise ProofPressureWideGridSelectorError("d128 single-head width-anchor signal drift")
    ...
    if {key: d64_four_head_seq64.get(key) for key in expected_d64_four_head_seq64} != expected_d64_four_head_seq64:
        raise ProofPressureWideGridSelectorError("d64 four-head seq64 signal drift")
    d128_width = current.get("d64_to_d128_two_head_seq32_width_frontier")
    if not isinstance(d128_width, dict):
        raise ProofPressureWideGridSelectorError("d128 width frontier signal drift")
    expected_d128_width = {
        "lookup_claim_growth": 1.0,
        "trace_row_growth": 1.0,
        "source_raw_proof_growth": 1.782318,
        "sidecar_raw_proof_growth": 0.961813,
        "fused_raw_proof_growth": 1.760615,
        "split_raw_proof_growth": 1.677561,
        "saving_growth": 1.017051,
    }
    if {key: d128_width.get(key) for key in expected_d128_width} != expected_d128_width:
        raise ProofPressureWideGridSelectorError("d128 width frontier signal drift")
    d128_sequence = current.get("d128_two_head_seq32_to_seq64")
    if not isinstance(d128_sequence, dict):
        raise ProofPressureWideGridSelectorError("d128 sequence frontier signal drift")
    expected_d128_sequence = {
        "lookup_claim_growth": 3.72973,
        "trace_row_growth": 4.0,
        "source_raw_proof_growth": 1.075591,
        "sidecar_raw_proof_growth": 1.297172,
        "fused_raw_proof_growth": 1.080697,
        "split_raw_proof_growth": 1.091811,
        "saving_growth": 1.244813,
    }
    if {key: d128_sequence.get(key) for key in expected_d128_sequence} != expected_d128_sequence:
        raise ProofPressureWideGridSelectorError("d128 sequence frontier signal drift")
    d128_head = current.get("d128_two_to_four_head_seq32")
    if not isinstance(d128_head, dict):
        raise ProofPressureWideGridSelectorError("d128 head frontier signal drift")
    expected_d128_head = {
        "lookup_claim_growth": 2.0,
        "trace_row_growth": 2.0,
        "source_raw_proof_growth": 1.045444,
        "sidecar_raw_proof_growth": 1.186061,
        "fused_raw_proof_growth": 1.044276,
        "split_raw_proof_growth": 1.055738,
        "saving_growth": 1.213536,
    }
    if {key: d128_head.get(key) for key in expected_d128_head} != expected_d128_head:
        raise ProofPressureWideGridSelectorError("d128 head frontier signal drift")
    d128_four_sequence = current.get("d128_four_head_seq32_to_seq64")
    if not isinstance(d128_four_sequence, dict):
        raise ProofPressureWideGridSelectorError("d128 four-head sequence frontier signal drift")
    expected_d128_four_sequence = {
        "lookup_claim_growth": 3.72973,
        "trace_row_growth": 4.0,
        "source_raw_proof_growth": 1.058041,
        "sidecar_raw_proof_growth": 1.188782,
        "fused_raw_proof_growth": 1.06491,
        "split_raw_proof_growth": 1.068793,
        "saving_growth": 1.114797,
    }
    if {key: d128_four_sequence.get(key) for key in expected_d128_four_sequence} != expected_d128_four_sequence:
        raise ProofPressureWideGridSelectorError("d128 four-head sequence frontier signal drift")
    d128_seq64_width = current.get("d64_to_d128_two_head_seq64_width_frontier")
    if not isinstance(d128_seq64_width, dict):
        raise ProofPressureWideGridSelectorError("d128 seq64 width frontier signal drift")
    expected_d128_seq64_width = {
        "lookup_claim_growth": 1.0,
        "trace_row_growth": 1.0,
        "source_raw_proof_growth": 1.803206,
        "sidecar_raw_proof_growth": 1.066883,
        "fused_raw_proof_growth": 1.767448,
        "split_raw_proof_growth": 1.701101,
        "saving_growth": 1.174259,
    }
    if {key: d128_seq64_width.get(key) for key in expected_d128_seq64_width} != expected_d128_seq64_width:
        raise ProofPressureWideGridSelectorError("d128 seq64 width frontier signal drift")
    d256_width = current.get("d128_to_d256_two_head_seq32_width_stress")
    if not isinstance(d256_width, dict):
        raise ProofPressureWideGridSelectorError("d256 width-stress signal drift")
    expected_d256_width = {
        "lookup_claim_growth": 1.0,
        "trace_row_growth": 1.0,
        "source_raw_proof_growth": 1.842296,
        "sidecar_raw_proof_growth": 0.997258,
        "fused_raw_proof_growth": 1.842162,
        "split_raw_proof_growth": 1.780438,
        "saving_growth": 0.930684,
        "d256_raw_saving_bytes": 30_143,
        "d256_fused_to_split_ratio": 0.964602,
    }
    if {key: d256_width.get(key) for key in expected_d256_width} != expected_d256_width:
        raise ProofPressureWideGridSelectorError("d256 width-stress signal drift")
    ...
    if accounting.get("attention_raw_proof_savings_bytes_total") != 766_883:
    ...
    if requested.get("selector_status") != "PARTIAL_D64_D128_AND_ONE_D256_SOURCE_BACKED_D256_SEQ64_MISSING":
    ...
    if requested.get("source_backed_requested_cell_count") != 13:
        raise ProofPressureWideGridSelectorError("wide row smuggling")
    if requested.get("missing_requested_cell_count") != 14:
    ...
    if requested.get("fully_missing_requested_widths") != []:
...
def mutation_cases(payload: dict[str, Any]) -> tuple[tuple[str, Any], ...]:
    return (
        ...
        ("wide_row_smuggling", lambda p: p["requested_grid_signal"].__setitem__("source_backed_requested_cell_count", 14)),
        ...
        (
            "d128_width_frontier_signal_drift",
            lambda p: p["current_signal"]["d64_to_d128_two_head_seq32_width_frontier"].__setitem__(
                "fused_raw_proof_growth", 1.0
            ),
        ),
        (
            "d128_sequence_frontier_signal_drift",
            lambda p: p["current_signal"]["d128_two_head_seq32_to_seq64"].__setitem__(
                "fused_raw_proof_growth", 1.0
            ),
        ),
        (
            "d128_head_frontier_signal_drift",
            lambda p: p["current_signal"]["d128_two_to_four_head_seq32"].__setitem__(
                "fused_raw_proof_growth", 1.0
            ),
        ),
        (
            "d128_four_head_sequence_frontier_signal_drift",
            lambda p: p["current_signal"]["d128_four_head_seq32_to_seq64"].__setitem__(
                "fused_raw_proof_growth", 1.0
            ),
        ),
        (
            "d128_seq64_width_frontier_signal_drift",
            lambda p: p["current_signal"]["d64_to_d128_two_head_seq64_width_frontier"].__setitem__(
                "fused_raw_proof_growth", 1.0
            ),
        ),
        (
            "d256_width_stress_signal_drift",
            lambda p: p["current_signal"]["d128_to_d256_two_head_seq32_width_stress"].__setitem__(
                "fused_raw_proof_growth", 1.0
            ),
        ),
        (
        ...
        (
            "d128_single_head_width_anchor_drift",
            lambda p: p["current_signal"]["d64_to_d128_single_head_seq16_width_anchor"].__setitem__(
                "fused_raw_proof_growth", 1.0
            ),
        ),
        (
        ...
        ("candidate_order_drift", lambda p: p["candidate_order"].append({"profile_id": "d128_h1_seq16"})),
        (
            "candidate_text_drift",

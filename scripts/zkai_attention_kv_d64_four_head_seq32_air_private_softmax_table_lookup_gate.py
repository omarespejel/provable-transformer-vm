#!/usr/bin/env python3
"""Checked AIR-constrained d64 four-head seq32 Softmax-table lookup sidecar gate for issue #715.

This gate records the narrow positive result: the existing native d64 four-head seq32
...
LOOKUP_ENVELOPE_JSON = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-d64-four-head-seq32-softmax-table-logup-sidecar-proof-2026-05.envelope.json"
SOURCE_INPUT_SCRIPT = ROOT / "scripts" / "zkai_attention_kv_stwo_native_d64_four_head_seq32_bounded_softmax_table_proof_input.py"
JSON_OUT = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-d64-four-head-seq32-softmax-table-logup-sidecar-gate-2026-05.json"
TSV_OUT = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-d64-four-head-seq32-softmax-table-logup-sidecar-gate-2026-05.tsv"

MAX_SOURCE_INPUT_JSON_BYTES = 33_554_432
MAX_LOOKUP_ENVELOPE_JSON_BYTES = 33_554_432

SCHEMA = "zkai-attention-kv-stwo-native-d64-four-head-seq32-softmax-table-logup-sidecar-gate-v1"
ISSUE = 715
SOURCE_ISSUE = 715
DECISION = "GO_NATIVE_STWO_AIR_CONSTRAINED_D64_FOUR_HEAD_SEQ32_SOFTMAX_TABLE_LOOKUP_RELATION_SIDECAR"
CLAIM_BOUNDARY = (
    "NATIVE_STWO_D64_FOUR_HEAD_SEQ32_BOUNDED_SOFTMAX_TABLE_LOOKUP_MEMBERSHIP_CONSTRAINED_BY_LOGUP_SIDECAR_"
...
NEXT_BACKEND_STEP = (
    "use this source-plus-sidecar comparator as the matched control for the d64 four-head seq32 fused native route and crossing-grid row"
)
...
LOOKUP_PROOF_VERSION = "stwo-attention-kv-d64-four-head-seq32-softmax-table-logup-sidecar-proof-v1"
LOOKUP_STATEMENT_VERSION = "zkai-attention-kv-stwo-native-d64-four-head-seq32-softmax-table-logup-sidecar-statement-v1"
LOOKUP_SEMANTIC_SCOPE = "d64_four_head_seq32_bounded_softmax_table_membership_constrained_by_native_stwo_logup_sidecar"
LOOKUP_VERIFIER_DOMAIN = "ptvm:zkai:attention-kv-stwo-native-d64-four-head-seq32-softmax-table-logup-sidecar:v1"
LOOKUP_TARGET_ID = "attention-kv-d64-four-head-seq32-causal-mask-bounded-softmax-table-logup-sidecar-v1"
LOOKUP_RELATION = "AttentionKvD64FourHeadSeq32SoftmaxTableLookupRelation"
LOOKUP_RELATION_WIDTH = 2
LOOKUP_PROOF_SIZE_BYTES = 34_147
LOOKUP_ENVELOPE_SIZE_BYTES = 19_731_274
LOOKUP_PROOF_COMMITMENTS = 4
LOOKUP_TRACE_COMMITMENTS = 3
LOOKUP_TABLE_MULTIPLICITIES = (
    {"gap": 0, "weight": 256, "multiplicity": 135},
...
PROOF_SIZE_RATIO = "0.938104"
ENVELOPE_SIZE_RATIO = "1.977347"
...
FUSED_TO_SOURCE_PLUS_SIDECAR_RATIO = "0.887604"
...
def verify_lookup_envelope_bytes_with_native_cli(envelope_bytes: bytes, label: str) -> None:
    ...
    command = [
        ...
        "stwo-backend",
        "--bin",
        "zkai_attention_kv_native_d64_four_head_seq32_softmax_table_lookup_proof",
        "--",
        "verify",
        str(tmp_path),
    ]
...
def build_payload() -> dict[str, Any]:
    ...
    payload["gate_commitment"] = blake2b_commitment(
        ...
        "ptvm:zkai:attention-kv-d64-four-head-seq32-softmax-table-logup-sidecar-gate:v1",
    )

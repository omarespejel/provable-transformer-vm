#!/usr/bin/env python3
"""Checked AIR-constrained d32 four-head seq16 Softmax-table lookup sidecar gate for issue #715.

This gate records the narrow positive result: the existing native d32 four-head seq16
...
LOOKUP_ENVELOPE_JSON = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-d32-four-head-longseq-softmax-table-logup-sidecar-proof-2026-05.envelope.json"
...
JSON_OUT = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-d32-four-head-longseq-softmax-table-logup-sidecar-gate-2026-05.json"
TSV_OUT = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-d32-four-head-longseq-softmax-table-logup-sidecar-gate-2026-05.tsv"

MAX_SOURCE_INPUT_JSON_BYTES = 4_194_304
MAX_LOOKUP_ENVELOPE_JSON_BYTES = 4_194_304

SCHEMA = "zkai-attention-kv-stwo-native-d32-four-head-longseq-softmax-table-logup-sidecar-gate-v1"
ISSUE = 715
SOURCE_ISSUE = 715
DECISION = "GO_NATIVE_STWO_AIR_CONSTRAINED_D32_FOUR_HEAD_LONGSEQ_SOFTMAX_TABLE_LOOKUP_RELATION_SIDECAR"
CLAIM_BOUNDARY = (
    "NATIVE_STWO_D32_FOUR_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_LOOKUP_MEMBERSHIP_CONSTRAINED_BY_LOGUP_SIDECAR_"
...
SOURCE_DECISION = "GO_INPUT_FOR_STWO_NATIVE_ATTENTION_KV_D32_FOUR_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_AIR_PROOF"
...
LOOKUP_PROOF_VERSION = "stwo-attention-kv-d32-four-head-longseq-softmax-table-logup-sidecar-proof-v1"
LOOKUP_STATEMENT_VERSION = "zkai-attention-kv-stwo-native-d32-four-head-longseq-softmax-table-logup-sidecar-statement-v1"
LOOKUP_SEMANTIC_SCOPE = "d32_four_head_longseq_bounded_softmax_table_membership_constrained_by_native_stwo_logup_sidecar"
LOOKUP_VERIFIER_DOMAIN = "ptvm:zkai:attention-kv-stwo-native-d32-four-head-longseq-softmax-table-logup-sidecar:v1"
LOOKUP_TARGET_ID = "attention-kv-d32-four-head-longseq-causal-mask-bounded-softmax-table-logup-sidecar-v1"
LOOKUP_RELATION = "AttentionKvD32FourHeadLongseqSoftmaxTableLookupRelation"
LOOKUP_RELATION_WIDTH = 2
LOOKUP_PROOF_SIZE_BYTES = 30_263
LOOKUP_ENVELOPE_SIZE_BYTES = 3_321_732
...
LOOKUP_TABLE_MULTIPLICITIES = (
    ...
    {"gap": 4, "weight": 64, "multiplicity": 5},
    {"gap": 5, "weight": 45, "multiplicity": 6},
    {"gap": 6, "weight": 32, "multiplicity": 5},
    {"gap": 7, "weight": 23, "multiplicity": 1},
    {"gap": 8, "weight": 16, "multiplicity": 573},
)
...
FUSED_TO_SOURCE_PLUS_SIDECAR_RATIO = "0.837170"
...
def verify_lookup_envelope_bytes_with_native_cli(envelope_bytes: bytes, label: str) -> None:
    ...
    command = [
        ...
        "stwo-backend",
        "--bin",
        "zkai_attention_kv_native_d32_four_head_longseq_softmax_table_lookup_proof",
        "--",
        "verify",
        str(tmp_path),
    ]
...
def build_payload() -> dict[str, Any]:
    ...
    payload["gate_commitment"] = blake2b_commitment(
        ...
        "ptvm:zkai:attention-kv-d32-four-head-longseq-softmax-table-logup-sidecar-gate:v1",
    )

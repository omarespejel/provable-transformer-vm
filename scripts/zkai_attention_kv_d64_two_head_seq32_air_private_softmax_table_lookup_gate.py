#!/usr/bin/env python3
"""Checked AIR-constrained d64 two-head seq32 Softmax-table lookup sidecar gate for issue #715.

This gate records the narrow positive result: the existing native d64 two-head seq32
...
LOOKUP_ENVELOPE_JSON = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-d64-two-head-seq32-softmax-table-logup-sidecar-proof-2026-05.envelope.json"
SOURCE_INPUT_SCRIPT = ROOT / "scripts" / "zkai_attention_kv_stwo_native_d64_two_head_seq32_bounded_softmax_table_proof_input.py"
JSON_OUT = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-d64-two-head-seq32-softmax-table-logup-sidecar-gate-2026-05.json"
TSV_OUT = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-d64-two-head-seq32-softmax-table-logup-sidecar-gate-2026-05.tsv"

MAX_SOURCE_INPUT_JSON_BYTES = 8_388_608
MAX_LOOKUP_ENVELOPE_JSON_BYTES = 16_777_216

SCHEMA = "zkai-attention-kv-stwo-native-d64-two-head-seq32-softmax-table-logup-sidecar-gate-v1"
ISSUE = 715
SOURCE_ISSUE = 715
DECISION = "GO_NATIVE_STWO_AIR_CONSTRAINED_D64_TWO_HEAD_SEQ32_SOFTMAX_TABLE_LOOKUP_RELATION_SIDECAR"
CLAIM_BOUNDARY = (
    "NATIVE_STWO_D64_TWO_HEAD_SEQ32_BOUNDED_SOFTMAX_TABLE_LOOKUP_MEMBERSHIP_CONSTRAINED_BY_LOGUP_SIDECAR_"
...
LOOKUP_PROOF_VERSION = "stwo-attention-kv-d64-two-head-seq32-softmax-table-logup-sidecar-proof-v1"
LOOKUP_STATEMENT_VERSION = "zkai-attention-kv-stwo-native-d64-two-head-seq32-softmax-table-logup-sidecar-statement-v1"
LOOKUP_SEMANTIC_SCOPE = "d64_two_head_seq32_bounded_softmax_table_membership_constrained_by_native_stwo_logup_sidecar"
LOOKUP_VERIFIER_DOMAIN = "ptvm:zkai:attention-kv-stwo-native-d64-two-head-seq32-softmax-table-logup-sidecar:v1"
LOOKUP_TARGET_ID = "attention-kv-d64-two-head-seq32-causal-mask-bounded-softmax-table-logup-sidecar-v1"
LOOKUP_RELATION = "AttentionKvD64TwoHeadSeq32SoftmaxTableLookupRelation"
LOOKUP_RELATION_WIDTH = 2
LOOKUP_PROOF_SIZE_BYTES = 36_400
LOOKUP_ENVELOPE_SIZE_BYTES = 9_978_658
...
LOOKUP_TABLE_MULTIPLICITIES = (
    ...
    {"gap": 8, "weight": 16, "multiplicity": 1107},
)
EXPECTED_LOOKUP_TABLE_MULTIPLICITIES = LOOKUP_TABLE_MULTIPLICITIES

FIXED_D64_TWO_HEAD_LOOKUP_CLAIMS = 104
FIXED_D64_TWO_HEAD_LOOKUP_PROOF_SIZE_BYTES = 18_137
FIXED_D64_TWO_HEAD_LOOKUP_ENVELOPE_SIZE_BYTES = 649_773
...
VALIDATION_COMMANDS = (
    ...
    "cargo +nightly-2025-07-14 run --locked --features stwo-backend --bin zkai_attention_kv_native_d64_two_head_seq32_softmax_table_lookup_proof -- prove docs/engineering/evidence/zkai-attention-kv-stwo-native-d64-two-head-seq32-bounded-softmax-table-proof-2026-05.json docs/engineering/evidence/zkai-attention-kv-stwo-native-d64-two-head-seq32-softmax-table-logup-sidecar-proof-2026-05.envelope.json",
    ...
    "python3.10 scripts/zkai_attention_kv_d64_two_head_seq32_air_private_softmax_table_lookup_gate.py --write-json docs/engineering/evidence/zkai-attention-kv-stwo-native-d64-two-head-seq32-softmax-table-logup-sidecar-gate-2026-05.json --write-tsv docs/engineering/evidence/zkai-attention-kv-stwo-native-d64-two-head-seq32-softmax-table-logup-sidecar-gate-2026-05.tsv",
...
def verify_lookup_envelope_bytes_with_native_cli(envelope_bytes: bytes, label: str) -> None:
    ...
    command = [
        ...
        "stwo-backend",
        "--bin",
        "zkai_attention_kv_native_d64_two_head_seq32_softmax_table_lookup_proof",
        "--",
        "verify",
        str(tmp_path),
    ]
...
def build_payload() -> dict[str, Any]:
    ...
    payload["gate_commitment"] = blake2b_commitment(
        ...
        "ptvm:zkai:attention-kv-d64-two-head-seq32-softmax-table-logup-sidecar-gate:v1",
    )

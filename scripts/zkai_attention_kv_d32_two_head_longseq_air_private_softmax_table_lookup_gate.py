#!/usr/bin/env python3
"""Checked AIR-constrained d32 two-head long-sequence Softmax-table lookup sidecar gate for issue #715.

This gate records the narrow positive result: the existing native d32 two-head long-sequence
...
LOOKUP_ENVELOPE_JSON = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-d32-two-head-longseq-softmax-table-logup-sidecar-proof-2026-05.envelope.json"
SOURCE_INPUT_SCRIPT = ROOT / "scripts" / "zkai_attention_kv_stwo_native_d32_two_head_longseq_bounded_softmax_table_proof_input.py"
JSON_OUT = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-d32-two-head-longseq-softmax-table-logup-sidecar-gate-2026-05.json"
TSV_OUT = EVIDENCE_DIR / "zkai-attention-kv-stwo-native-d32-two-head-longseq-softmax-table-logup-sidecar-gate-2026-05.tsv"

MAX_SOURCE_INPUT_JSON_BYTES = 2_097_152
MAX_LOOKUP_ENVELOPE_JSON_BYTES = 4_194_304

SCHEMA = "zkai-attention-kv-stwo-native-d32-two-head-longseq-softmax-table-logup-sidecar-gate-v1"
ISSUE = 715
SOURCE_ISSUE = 715
DECISION = "GO_NATIVE_STWO_AIR_CONSTRAINED_D32_TWO_HEAD_LONGSEQ_SOFTMAX_TABLE_LOOKUP_RELATION_SIDECAR"
CLAIM_BOUNDARY = (
    "NATIVE_STWO_D32_TWO_HEAD_LONGSEQ_BOUNDED_SOFTMAX_TABLE_LOOKUP_MEMBERSHIP_CONSTRAINED_BY_LOGUP_SIDECAR_"
...
NEXT_BACKEND_STEP = (
    "use this source-plus-sidecar comparator as the matched control for the existing long-sequence fused native route"
)
...
LOOKUP_PROOF_VERSION = "stwo-attention-kv-d32-two-head-longseq-softmax-table-logup-sidecar-proof-v1"
LOOKUP_STATEMENT_VERSION = "zkai-attention-kv-stwo-native-d32-two-head-longseq-softmax-table-logup-sidecar-statement-v1"
LOOKUP_SEMANTIC_SCOPE = "d32_two_head_longseq_bounded_softmax_table_membership_constrained_by_native_stwo_logup_sidecar"
LOOKUP_VERIFIER_DOMAIN = "ptvm:zkai:attention-kv-stwo-native-d32-two-head-longseq-softmax-table-logup-sidecar:v1"
LOOKUP_TARGET_ID = "attention-kv-d32-two-head-longseq-causal-mask-bounded-softmax-table-logup-sidecar-v1"
LOOKUP_RELATION = "AttentionKvD32TwoHeadLongseqSoftmaxTableLookupRelation"
LOOKUP_RELATION_WIDTH = 2
LOOKUP_PROOF_SIZE_BYTES = 27_075
LOOKUP_ENVELOPE_SIZE_BYTES = 1_753_808
LOOKUP_PROOF_COMMITMENTS = 4
LOOKUP_TRACE_COMMITMENTS = 3
LOOKUP_TABLE_MULTIPLICITIES = (
    {"gap": 0, "weight": 256, "multiplicity": 39},
    ...
    {"gap": 8, "weight": 16, "multiplicity": 288},
)
...
CLAIM_COUNT_RATIO = "3.230769"
PROOF_SIZE_RATIO = "1.492805"
ENVELOPE_SIZE_RATIO = "2.699109"
SOURCE_PROOF_SIZE_BYTES = 135_063
FUSED_PROOF_SIZE_BYTES = 132_543
FUSED_ENVELOPE_SIZE_BYTES = 2_598_632
...
FUSED_TO_SOURCE_PLUS_SIDECAR_RATIO = "0.817470"
...
VALIDATION_COMMANDS = (
    "cargo +nightly-2025-07-14 test --locked attention_kv_d32_two_head_longseq_softmax_table_lookup --lib --features stwo-backend",
    "cargo +nightly-2025-07-14 run --locked --features stwo-backend --bin zkai_attention_kv_native_d32_two_head_longseq_softmax_table_lookup_proof -- prove docs/engineering/evidence/zkai-attention-kv-stwo-native-d32-two-head-longseq-bounded-softmax-table-proof-2026-05.json docs/engineering/evidence/zkai-attention-kv-stwo-native-d32-two-head-longseq-softmax-table-logup-sidecar-proof-2026-05.envelope.json",
    "cargo +nightly-2025-07-14 run --locked --features stwo-backend --bin zkai_attention_kv_native_d32_two_head_longseq_softmax_table_lookup_proof -- verify docs/engineering/evidence/zkai-attention-kv-stwo-native-d32-two-head-longseq-softmax-table-logup-sidecar-proof-2026-05.envelope.json",
    "python3 scripts/zkai_attention_kv_d32_two_head_longseq_air_private_softmax_table_lookup_gate.py --write-json docs/engineering/evidence/zkai-attention-kv-stwo-native-d32-two-head-longseq-softmax-table-logup-sidecar-gate-2026-05.json --write-tsv docs/engineering/evidence/zkai-attention-kv-stwo-native-d32-two-head-longseq-softmax-table-logup-sidecar-gate-2026-05.tsv",
    "python3 -m unittest scripts.tests.test_zkai_attention_kv_d32_two_head_longseq_air_private_softmax_table_lookup_gate",
    "just gate-fast",
    "just gate",
)
...
EXPECTED_MUTATION_NAMES = (
    ...
    "fixed_d32_two_head_comparison_metric_smuggling",
...
TSV_COLUMNS = (
    ...
    "lookup_claims",
    "fixed_d32_two_head_lookup_claims",
    "claim_count_ratio",
    "lookup_proof_size_bytes",
    "fixed_d32_two_head_lookup_proof_size_bytes",
    "proof_size_ratio",
    "lookup_envelope_size_bytes",
    "fixed_d32_two_head_lookup_envelope_size_bytes",
    "envelope_size_ratio",
...
def verify_lookup_envelope_bytes_with_native_cli(envelope_bytes: bytes, label: str) -> None:
    ...
    command = [
        ...
        "stwo-backend",
        "--bin",
        "zkai_attention_kv_native_d32_two_head_longseq_softmax_table_lookup_proof",
        "--",
        "verify",
        str(tmp_path),
    ]
...
def build_payload() -> dict[str, Any]:
    ...
    payload: dict[str, Any] = {
        ...
        "fixed_d32_two_head_comparison": fixed_d32_two_head_comparison(),
    ...
    payload["gate_commitment"] = blake2b_commitment(
        {
            ...
            "proof_size_ratio": payload["fixed_d32_two_head_comparison"]["proof_size_ratio"],
        ...
        "ptvm:zkai:attention-kv-d32-two-head-longseq-softmax-table-logup-sidecar-gate:v1",
    )
...
def mutate_payload(payload: dict[str, Any], name: str) -> dict[str, Any]:
    ...
    elif name == "fixed_d32_two_head_comparison_metric_smuggling":
        mutated["fixed_d32_two_head_comparison"]["proof_size_ratio"] = "1.000000"
...
def to_tsv(payload: dict[str, Any]) -> str:
    ...
    comparison = payload["fixed_d32_two_head_comparison"]
    row = {
        "decision": payload["decision"],
        "lookup_status": payload["lookup_status"],
        "fused_component_status": payload["fused_component_status"],
        "lookup_claims": receipt["lookup_claims"],
        "fixed_d32_two_head_lookup_claims": comparison["fixed_d32_two_head_lookup_claims"],
        "claim_count_ratio": comparison["claim_count_ratio"],
        "lookup_proof_size_bytes": receipt["lookup_proof_size_bytes"],
        "fixed_d32_two_head_lookup_proof_size_bytes": comparison["fixed_d32_two_head_lookup_proof_size_bytes"],
        "proof_size_ratio": comparison["proof_size_ratio"],
        "lookup_envelope_size_bytes": receipt["lookup_envelope_size_bytes"],
        "fixed_d32_two_head_lookup_envelope_size_bytes": comparison["fixed_d32_two_head_lookup_envelope_size_bytes"],
